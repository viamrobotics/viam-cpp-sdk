...
inline ::proto::rpc::webrtc::v1::RequestHeaders* Request::release_headers() {
  ...
  if (_internal_has_headers()) {
    clear_has_type();
    ::proto::rpc::webrtc::v1::RequestHeaders* temp = _impl_.type_.headers_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
...
inline ::proto::rpc::webrtc::v1::RequestHeaders* Request::_internal_mutable_headers() {
  if (!_internal_has_headers()) {
    clear_type();
    set_has_headers();
    _impl_.type_.headers_ = CreateMaybeMessage< ::proto::rpc::webrtc::v1::RequestHeaders >(GetArenaForAllocation());
  }
...
inline ::proto::rpc::webrtc::v1::RequestMessage* Request::release_message() {
  ...
  if (_internal_has_message()) {
    clear_has_type();
    ::proto::rpc::webrtc::v1::RequestMessage* temp = _impl_.type_.message_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
...
inline ::proto::rpc::webrtc::v1::RequestMessage* Request::_internal_mutable_message() {
  if (!_internal_has_message()) {
    clear_type();
    set_has_message();
    _impl_.type_.message_ = CreateMaybeMessage< ::proto::rpc::webrtc::v1::RequestMessage >(GetArenaForAllocation());
  }
...
inline bool RequestMessage::_internal_has_packet_message() const {
  return this != internal_default_instance() && _impl_.packet_message_ != nullptr;
}
...
inline void RequestMessage::unsafe_arena_set_allocated_packet_message(
    ::proto::rpc::webrtc::v1::PacketMessage* packet_message) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.packet_message_);
  }
  _impl_.packet_message_ = packet_message;
  if (packet_message) {
...
inline ::proto::rpc::webrtc::v1::ResponseHeaders* Response::release_headers() {
  ...
  if (_internal_has_headers()) {
    clear_has_type();
    ::proto::rpc::webrtc::v1::ResponseHeaders* temp = _impl_.type_.headers_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.type_.headers_ = nullptr;
...
inline ::proto::rpc::webrtc::v1::ResponseHeaders* Response::_internal_mutable_headers() {
  if (!_internal_has_headers()) {
    clear_type();
    set_has_headers();
    _impl_.type_.headers_ = CreateMaybeMessage< ::proto::rpc::webrtc::v1::ResponseHeaders >(GetArenaForAllocation());
  }
  return _impl_.type_.headers_;
}
...
inline ::proto::rpc::webrtc::v1::ResponseMessage* Response::release_message() {
  ...
  if (_internal_has_message()) {
    clear_has_type();
    ::proto::rpc::webrtc::v1::ResponseMessage* temp = _impl_.type_.message_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.type_.message_ = nullptr;
...
inline ::proto::rpc::webrtc::v1::ResponseMessage* Response::_internal_mutable_message() {
  if (!_internal_has_message()) {
    clear_type();
    set_has_message();
    _impl_.type_.message_ = CreateMaybeMessage< ::proto::rpc::webrtc::v1::ResponseMessage >(GetArenaForAllocation());
  }
  return _impl_.type_.message_;
}
...
inline ::proto::rpc::webrtc::v1::ResponseTrailers* Response::release_trailers() {
  ...
  if (_internal_has_trailers()) {
    clear_has_type();
    ::proto::rpc::webrtc::v1::ResponseTrailers* temp = _impl_.type_.trailers_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
...
inline ::proto::rpc::webrtc::v1::ResponseTrailers* Response::_internal_mutable_trailers() {
  if (!_internal_has_trailers()) {
    clear_type();
    set_has_trailers();
    _impl_.type_.trailers_ = CreateMaybeMessage< ::proto::rpc::webrtc::v1::ResponseTrailers >(GetArenaForAllocation());
  }
