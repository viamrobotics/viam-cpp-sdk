...
inline void UploadFileRequest::set_name(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_name()) {
    clear_data();
    set_has_name();
    data_.name_.InitDefault();
  }
  data_.name_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void UploadFileRequest::_internal_set_name(const std::string& value) {
  ...
  data_.name_.Set(value, GetArenaForAllocation());
}
inline std::string* UploadFileRequest::_internal_mutable_name() {
  ...
  return data_.name_.Mutable(      GetArenaForAllocation());
}
...
inline void UploadFileRequest::set_allocated_name(std::string* name) {
  ...
  if (name != nullptr) {
    set_has_name();
    data_.name_.InitAllocated(name, GetArenaForAllocation());
  }
...
inline void UploadFileRequest::set_chunk_data(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_chunk_data()) {
    clear_data();
    set_has_chunk_data();
    data_.chunk_data_.InitDefault();
  }
  data_.chunk_data_.SetBytes( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void UploadFileRequest::_internal_set_chunk_data(const std::string& value) {
  ...
  data_.chunk_data_.Set(value, GetArenaForAllocation());
}
inline std::string* UploadFileRequest::_internal_mutable_chunk_data() {
  ...
  return data_.chunk_data_.Mutable(      GetArenaForAllocation());
}
inline std::string* UploadFileRequest::release_chunk_data() {
  ...
  if (_internal_has_chunk_data()) {
    clear_has_data();
    return data_.chunk_data_.Release();
  } else {
    return nullptr;
  }
}
inline void UploadFileRequest::set_allocated_chunk_data(std::string* chunk_data) {
  ...
  if (chunk_data != nullptr) {
    set_has_chunk_data();
    data_.chunk_data_.InitAllocated(chunk_data, GetArenaForAllocation());
  }
