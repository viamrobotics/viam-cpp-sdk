...
inline ::google::api::expr::v1alpha1::EnumValue* Value::_internal_mutable_enum_value() {
  if (!_internal_has_enum_value()) {
    clear_kind();
    set_has_enum_value();
    kind_.enum_value_ = CreateMaybeMessage< ::google::api::expr::v1alpha1::EnumValue >(GetArenaForAllocation());
  }
...
inline ::google::api::expr::v1alpha1::MapValue* Value::_internal_mutable_map_value() {
  if (!_internal_has_map_value()) {
    clear_kind();
    set_has_map_value();
    kind_.map_value_ = CreateMaybeMessage< ::google::api::expr::v1alpha1::MapValue >(GetArenaForAllocation());
  }
...
inline ::google::api::expr::v1alpha1::ListValue* Value::_internal_mutable_list_value() {
  if (!_internal_has_list_value()) {
    clear_kind();
    set_has_list_value();
    kind_.list_value_ = CreateMaybeMessage< ::google::api::expr::v1alpha1::ListValue >(GetArenaForAllocation());
  }
