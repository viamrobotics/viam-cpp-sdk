...
inline ::google::api::expr::v1beta1::IdentDecl* Decl::_internal_mutable_ident() {
  if (!_internal_has_ident()) {
    clear_kind();
    set_has_ident();
    kind_.ident_ = CreateMaybeMessage< ::google::api::expr::v1beta1::IdentDecl >(GetArenaForAllocation());
  }
  return kind_.ident_;
}
...
inline ::google::api::expr::v1beta1::FunctionDecl* Decl::_internal_mutable_function() {
  if (!_internal_has_function()) {
    clear_kind();
    set_has_function();
    kind_.function_ = CreateMaybeMessage< ::google::api::expr::v1beta1::FunctionDecl >(GetArenaForAllocation());
  }
