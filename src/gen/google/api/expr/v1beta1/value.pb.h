...
inline void Value::set_bytes_value(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_bytes_value()) {
    clear_kind();
    set_has_bytes_value();
    kind_.bytes_value_.InitDefault();
  }
  kind_.bytes_value_.SetBytes( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Value::_internal_set_bytes_value(const std::string& value) {
  ...
  kind_.bytes_value_.Set(value, GetArenaForAllocation());
}
inline std::string* Value::_internal_mutable_bytes_value() {
  ...
  return kind_.bytes_value_.Mutable(      GetArenaForAllocation());
}
inline std::string* Value::release_bytes_value() {
  ...
  if (_internal_has_bytes_value()) {
    clear_has_kind();
    return kind_.bytes_value_.Release();
  } else {
    return nullptr;
  }
}
inline void Value::set_allocated_bytes_value(std::string* bytes_value) {
  ...
  if (bytes_value != nullptr) {
    set_has_bytes_value();
    kind_.bytes_value_.InitAllocated(bytes_value, GetArenaForAllocation());
  }
...
inline ::google::api::expr::v1beta1::EnumValue* Value::_internal_mutable_enum_value() {
  if (!_internal_has_enum_value()) {
    clear_kind();
    set_has_enum_value();
    kind_.enum_value_ = CreateMaybeMessage< ::google::api::expr::v1beta1::EnumValue >(GetArenaForAllocation());
  }
...
inline ::PROTOBUF_NAMESPACE_ID::Any* Value::_internal_mutable_object_value() {
  if (!_internal_has_object_value()) {
    clear_kind();
    set_has_object_value();
    kind_.object_value_ = CreateMaybeMessage< ::PROTOBUF_NAMESPACE_ID::Any >(GetArenaForAllocation());
  }
...
inline ::google::api::expr::v1beta1::MapValue* Value::_internal_mutable_map_value() {
  if (!_internal_has_map_value()) {
    clear_kind();
    set_has_map_value();
    kind_.map_value_ = CreateMaybeMessage< ::google::api::expr::v1beta1::MapValue >(GetArenaForAllocation());
  }
...
inline ::google::api::expr::v1beta1::ListValue* Value::_internal_mutable_list_value() {
  if (!_internal_has_list_value()) {
    clear_kind();
    set_has_list_value();
    kind_.list_value_ = CreateMaybeMessage< ::google::api::expr::v1beta1::ListValue >(GetArenaForAllocation());
  }
...
inline void Value::set_type_value(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_type_value()) {
    clear_kind();
    set_has_type_value();
    kind_.type_value_.InitDefault();
  }
  kind_.type_value_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Value::_internal_set_type_value(const std::string& value) {
  ...
  kind_.type_value_.Set(value, GetArenaForAllocation());
}
...
inline void Value::set_allocated_type_value(std::string* type_value) {
  ...
  if (type_value != nullptr) {
    set_has_type_value();
    kind_.type_value_.InitAllocated(type_value, GetArenaForAllocation());
  }
