...
class SLAMService final {
 public:
  ...
  typedef WithAsyncMethod_GetPosition<WithAsyncMethod_GetMap<Service > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_GetPosition<WithCallbackMethod_GetMap<Service > > CallbackService;
  ...
  typedef WithStreamedUnaryMethod_GetPosition<WithStreamedUnaryMethod_GetMap<Service > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_GetPosition<WithStreamedUnaryMethod_GetMap<Service > > StreamedService;
};
