...
inline void MoveRequest::unsafe_arena_set_allocated_slam_service_name(
    ::viam::common::v1::ResourceName* slam_service_name) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.slam_service_name_);
  }
  _impl_.slam_service_name_ = slam_service_name;
