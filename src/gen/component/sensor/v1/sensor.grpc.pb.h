...
class SensorService final {
 public:
  ...
  typedef WithAsyncMethod_GetReadings<Service > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_GetReadings<Service > CallbackService;
  ...
  typedef WithStreamedUnaryMethod_GetReadings<Service > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_GetReadings<Service > StreamedService;
};
