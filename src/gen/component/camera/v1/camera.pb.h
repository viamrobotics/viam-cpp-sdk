...
class GetImageResponse final :
 ...
 public:
  ...
  enum : int {
    ...
    kImageFieldNumber = 2,
    kWidthPxFieldNumber = 3,
    kHeightPxFieldNumber = 4,
  };
  ...
  void clear_width_px();
  int64_t width_px() const;
  void set_width_px(int64_t value);
  private:
  int64_t _internal_width_px() const;
  void _internal_set_width_px(int64_t value);
  public:

  // int64 height_px = 4 [json_name = "heightPx"];
  void clear_height_px();
  int64_t height_px() const;
  void set_height_px(int64_t value);
  private:
  int64_t _internal_height_px() const;
  void _internal_set_height_px(int64_t value);
  public:
...
// int64 width_px = 3 [json_name = "widthPx"];
inline void GetImageResponse::clear_width_px() {
  _impl_.width_px_ = int64_t{0};
}
inline int64_t GetImageResponse::_internal_width_px() const {
  return _impl_.width_px_;
}
inline int64_t GetImageResponse::width_px() const {
  // @@protoc_insertion_point(field_get:viam.component.camera.v1.GetImageResponse.width_px)
  return _internal_width_px();
}
inline void GetImageResponse::_internal_set_width_px(int64_t value) {
  
  _impl_.width_px_ = value;
}
inline void GetImageResponse::set_width_px(int64_t value) {
  _internal_set_width_px(value);
  // @@protoc_insertion_point(field_set:viam.component.camera.v1.GetImageResponse.width_px)
}

// int64 height_px = 4 [json_name = "heightPx"];
inline void GetImageResponse::clear_height_px() {
  _impl_.height_px_ = int64_t{0};
}
inline int64_t GetImageResponse::_internal_height_px() const {
  return _impl_.height_px_;
}
inline int64_t GetImageResponse::height_px() const {
  // @@protoc_insertion_point(field_get:viam.component.camera.v1.GetImageResponse.height_px)
  return _internal_height_px();
}
inline void GetImageResponse::_internal_set_height_px(int64_t value) {
  
  _impl_.height_px_ = value;
}
inline void GetImageResponse::set_height_px(int64_t value) {
  _internal_set_height_px(value);
  // @@protoc_insertion_point(field_set:viam.component.camera.v1.GetImageResponse.height_px)
}
