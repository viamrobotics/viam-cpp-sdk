...
class CameraService final {
 public:
  ...
  typedef WithAsyncMethod_GetImage<WithAsyncMethod_RenderFrame<WithAsyncMethod_GetPointCloud<WithAsyncMethod_GetProperties<Service > > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_GetImage<WithCallbackMethod_RenderFrame<WithCallbackMethod_GetPointCloud<WithCallbackMethod_GetProperties<Service > > > > CallbackService;
  ...
  typedef WithStreamedUnaryMethod_GetImage<WithStreamedUnaryMethod_RenderFrame<WithStreamedUnaryMethod_GetPointCloud<WithStreamedUnaryMethod_GetProperties<Service > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_GetImage<WithStreamedUnaryMethod_RenderFrame<WithStreamedUnaryMethod_GetPointCloud<WithStreamedUnaryMethod_GetProperties<Service > > > > StreamedService;
};
