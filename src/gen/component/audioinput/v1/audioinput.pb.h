...
inline ::viam::component::audioinput::v1::AudioChunkInfo* ChunksResponse::release_info() {
  ...
  if (_internal_has_info()) {
    clear_has_type();
    ::viam::component::audioinput::v1::AudioChunkInfo* temp = _impl_.type_.info_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
...
inline ::viam::component::audioinput::v1::AudioChunkInfo* ChunksResponse::_internal_mutable_info() {
  if (!_internal_has_info()) {
    clear_type();
    set_has_info();
    _impl_.type_.info_ = CreateMaybeMessage< ::viam::component::audioinput::v1::AudioChunkInfo >(GetArenaForAllocation());
  }
...
inline ::viam::component::audioinput::v1::AudioChunk* ChunksResponse::release_chunk() {
  ...
  if (_internal_has_chunk()) {
    clear_has_type();
    ::viam::component::audioinput::v1::AudioChunk* temp = _impl_.type_.chunk_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
...
inline ::viam::component::audioinput::v1::AudioChunk* ChunksResponse::_internal_mutable_chunk() {
  if (!_internal_has_chunk()) {
    clear_type();
    set_has_chunk();
    _impl_.type_.chunk_ = CreateMaybeMessage< ::viam::component::audioinput::v1::AudioChunk >(GetArenaForAllocation());
  }
