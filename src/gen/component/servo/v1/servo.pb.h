...
template<> ::viam::component::servo::v1::IsMovingRequest* Arena::CreateMaybeMessage<::viam::component::servo::v1::IsMovingRequest>(Arena*);
template<> ::viam::component::servo::v1::IsMovingResponse* Arena::CreateMaybeMessage<::viam::component::servo::v1::IsMovingResponse>(Arena*);
...
class IsMovingRequest final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:viam.component.servo.v1.IsMovingRequest) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "viam.component.servo.v1.IsMovingRequest";
  }
  protected:
...
class IsMovingResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:viam.component.servo.v1.IsMovingResponse) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "viam.component.servo.v1.IsMovingResponse";
  }
  protected:
