...
class Fragment final :
 ...
 public:
  ...
  void set_use_count(int32_t value);
  private:
  int32_t _internal_use_count() const;
  void _internal_set_use_count(int32_t value);
  public:
...
// int32 use_count = 9 [json_name = "useCount"];
inline void Fragment::clear_use_count() {
  use_count_ = 0;
}
inline int32_t Fragment::_internal_use_count() const {
  return use_count_;
}
inline int32_t Fragment::use_count() const {
  // @@protoc_insertion_point(field_get:viam.app.v1.Fragment.use_count)
  return _internal_use_count();
}
inline void Fragment::_internal_set_use_count(int32_t value) {
  
  use_count_ = value;
}
inline void Fragment::set_use_count(int32_t value) {
  _internal_set_use_count(value);
  // @@protoc_insertion_point(field_set:viam.app.v1.Fragment.use_count)
}
