...
const uint32_t TableStruct_app_2fmltraining_2fv1_2fml_5ftraining_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::viam::app::mltraining::v1::TrainingJob, processing_),
};
...
const char descriptor_table_protodef_app_2fmltraining_2fv1_2fml_5ftraining_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "model_metadata\"R\rmodelMetadata\022H\n\nproces"
  "sing\030\006 \001(\010B(\232\204\236\003#bson:\"processing\" json:"
  "\"processing\"R\nprocessing*~\n\tModelType\022\032\n"
  "\026MODEL_TYPE_UNSPECIFIED\020\000\022*\n&MODEL_TYPE_"
  "SINGLE_LABEL_CLASSIFICATION\020\001\022)\n%MODEL_T"
  "YPE_MULTI_LABEL_CLASSIFICATION\020\002*\252\001\n\016Tra"
  ...
  "LED\020\0042\376\001\n\021MLTrainingService\022x\n\021SubmitTra"
  "iningJob\0220.viam.app.mltraining.v1.Submit"
  "TrainingJobRequest\0321.viam.app.mltraining"
  ".v1.SubmitTrainingJobResponse\022o\n\016GetTrai"
  "ningJob\022-.viam.app.mltraining.v1.GetTrai"
  "ningJobRequest\032..viam.app.mltraining.v1."
  "GetTrainingJobResponseB#Z!go.viam.com/ap"
  "i/app/mltraining/v1b\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_app_2fmltraining_2fv1_2fml_5ftraining_2eproto = {
    false, false, 2107, descriptor_table_protodef_app_2fmltraining_2fv1_2fml_5ftraining_2eproto,
...
::memset(reinterpret_cast<char*>(this) + static_cast<size_t>(
    ...
    reinterpret_cast<char*>(&metadata_)) + sizeof(processing_));
}
    ...
    switch (tag >> 3) {
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 42)) {
          ...
          goto handle_unusual;
        continue;
      // bool processing = 6 [json_name = "processing", (.tagger.v1.tags) = "bson:\"processing\" json:\"processing\""];
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 48)) {
          processing_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint64(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* TrainingJob::_InternalSerialize(
  ...
  if (this->_internal_processing() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteBoolToArray(6, this->_internal_processing(), target);
  }
...
void TrainingJob::InternalSwap(TrainingJob* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(TrainingJob, processing_)
      + sizeof(TrainingJob::processing_)
