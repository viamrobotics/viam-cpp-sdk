...
// bool processing = 6 [json_name = "processing", (.tagger.v1.tags) = "bson:\"processing\" json:\"processing\""];
inline void TrainingJob::clear_processing() {
  processing_ = false;
}
inline bool TrainingJob::_internal_processing() const {
  return processing_;
}
inline bool TrainingJob::processing() const {
  // @@protoc_insertion_point(field_get:viam.app.mltraining.v1.TrainingJob.processing)
  return _internal_processing();
}
inline void TrainingJob::_internal_set_processing(bool value) {
  
  processing_ = value;
}
inline void TrainingJob::set_processing(bool value) {
  _internal_set_processing(value);
  // @@protoc_insertion_point(field_set:viam.app.mltraining.v1.TrainingJob.processing)
}
