...
inline void UploadRequest::set_has_sensor_contents() {
  _impl_._oneof_case_[0] = kSensorContents;
}
...
inline ::viam::app::datasync::v1::SensorData* UploadRequest::release_sensor_contents() {
  ...
  if (_internal_has_sensor_contents()) {
    clear_has_upload_packet();
    ::viam::app::datasync::v1::SensorData* temp = _impl_.upload_packet_.sensor_contents_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
    _impl_.upload_packet_.sensor_contents_ = nullptr;
    return temp;
  } else {
    return nullptr;
  }
...
inline ::viam::app::datasync::v1::SensorData* UploadRequest::_internal_mutable_sensor_contents() {
  if (!_internal_has_sensor_contents()) {
    clear_upload_packet();
    set_has_sensor_contents();
    _impl_.upload_packet_.sensor_contents_ = CreateMaybeMessage< ::viam::app::datasync::v1::SensorData >(GetArenaForAllocation());
  }
  return _impl_.upload_packet_.sensor_contents_;
}
...
inline int32_t UploadResponse::_internal_requests_written() const {
  return _impl_.requests_written_;
}
...
inline void UploadResponse::_internal_set_requests_written(int32_t value) {
  ...
  _impl_.requests_written_ = value;
}
