 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    virtual ::grpc::Status GetPose(::grpc::ClientContext* context, const ::viam::robot::v1::GetPoseRequest& request, ::viam::robot::v1::GetPoseResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::viam::robot::v1::GetPoseResponse>> AsyncGetPose(::grpc::ClientContext* context, const ::viam::robot::v1::GetPoseRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::viam::robot::v1::GetPoseResponse>>(AsyncGetPoseRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::viam::robot::v1::GetPoseResponse>> PrepareAsyncGetPose(::grpc::ClientContext* context, const ::viam::robot::v1::GetPoseRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::viam::robot::v1::GetPoseResponse>>(PrepareAsyncGetPoseRaw(context, request, cq));
    }
    ...
    virtual ::grpc::Status UploadDataFromPath(::grpc::ClientContext* context, const ::viam::robot::v1::UploadDataFromPathRequest& request, ::viam::robot::v1::UploadDataFromPathResponse* response) = 0;
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::viam::robot::v1::UploadDataFromPathResponse>> AsyncUploadDataFromPath(::grpc::ClientContext* context, const ::viam::robot::v1::UploadDataFromPathRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::viam::robot::v1::UploadDataFromPathResponse>>(AsyncUploadDataFromPathRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::viam::robot::v1::UploadDataFromPathResponse>> PrepareAsyncUploadDataFromPath(::grpc::ClientContext* context, const ::viam::robot::v1::UploadDataFromPathRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReaderInterface< ::viam::robot::v1::UploadDataFromPathResponse>>(PrepareAsyncUploadDataFromPathRaw(context, request, cq));
    }
    class async_interface {
     public:
      ...
      // GetPose returns the pose of a component in a desired referenceframe.
      virtual void GetPose(::grpc::ClientContext* context, const ::viam::robot::v1::GetPoseRequest* request, ::viam::robot::v1::GetPoseResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void GetPose(::grpc::ClientContext* context, const ::viam::robot::v1::GetPoseRequest* request, ::viam::robot::v1::GetPoseResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      // TransformPose returns a pose in one referenceframe in a desired referenceframe.
      ...
      // UploadDataFromPath uploads a file or directory from the robot to the cloud
      // via the configured data manager service.
      virtual void UploadDataFromPath(::grpc::ClientContext* context, const ::viam::robot::v1::UploadDataFromPathRequest* request, ::viam::robot::v1::UploadDataFromPathResponse* response, std::function<void(::grpc::Status)>) = 0;
      virtual void UploadDataFromPath(::grpc::ClientContext* context, const ::viam::robot::v1::UploadDataFromPathRequest* request, ::viam::robot::v1::UploadDataFromPathResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
    };
   ...
   private:
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::viam::robot::v1::GetPoseResponse>* AsyncGetPoseRaw(::grpc::ClientContext* context, const ::viam::robot::v1::GetPoseRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::viam::robot::v1::GetPoseResponse>* PrepareAsyncGetPoseRaw(::grpc::ClientContext* context, const ::viam::robot::v1::GetPoseRequest& request, ::grpc::CompletionQueue* cq) = 0;
    ...
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::viam::robot::v1::UploadDataFromPathResponse>* AsyncUploadDataFromPathRaw(::grpc::ClientContext* context, const ::viam::robot::v1::UploadDataFromPathRequest& request, ::grpc::CompletionQueue* cq) = 0;
    virtual ::grpc::ClientAsyncResponseReaderInterface< ::viam::robot::v1::UploadDataFromPathResponse>* PrepareAsyncUploadDataFromPathRaw(::grpc::ClientContext* context, const ::viam::robot::v1::UploadDataFromPathRequest& request, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    ...
    ::grpc::Status GetPose(::grpc::ClientContext* context, const ::viam::robot::v1::GetPoseRequest& request, ::viam::robot::v1::GetPoseResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::viam::robot::v1::GetPoseResponse>> AsyncGetPose(::grpc::ClientContext* context, const ::viam::robot::v1::GetPoseRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::viam::robot::v1::GetPoseResponse>>(AsyncGetPoseRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::viam::robot::v1::GetPoseResponse>> PrepareAsyncGetPose(::grpc::ClientContext* context, const ::viam::robot::v1::GetPoseRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::viam::robot::v1::GetPoseResponse>>(PrepareAsyncGetPoseRaw(context, request, cq));
    }
    ...
    ::grpc::Status UploadDataFromPath(::grpc::ClientContext* context, const ::viam::robot::v1::UploadDataFromPathRequest& request, ::viam::robot::v1::UploadDataFromPathResponse* response) override;
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::viam::robot::v1::UploadDataFromPathResponse>> AsyncUploadDataFromPath(::grpc::ClientContext* context, const ::viam::robot::v1::UploadDataFromPathRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::viam::robot::v1::UploadDataFromPathResponse>>(AsyncUploadDataFromPathRaw(context, request, cq));
    }
    std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::viam::robot::v1::UploadDataFromPathResponse>> PrepareAsyncUploadDataFromPath(::grpc::ClientContext* context, const ::viam::robot::v1::UploadDataFromPathRequest& request, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncResponseReader< ::viam::robot::v1::UploadDataFromPathResponse>>(PrepareAsyncUploadDataFromPathRaw(context, request, cq));
    }
    class async final :
     ...
     public:
      ...
      void GetPose(::grpc::ClientContext* context, const ::viam::robot::v1::GetPoseRequest* request, ::viam::robot::v1::GetPoseResponse* response, std::function<void(::grpc::Status)>) override;
      void GetPose(::grpc::ClientContext* context, const ::viam::robot::v1::GetPoseRequest* request, ::viam::robot::v1::GetPoseResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      ...
      void UploadDataFromPath(::grpc::ClientContext* context, const ::viam::robot::v1::UploadDataFromPathRequest* request, ::viam::robot::v1::UploadDataFromPathResponse* response, std::function<void(::grpc::Status)>) override;
      void UploadDataFromPath(::grpc::ClientContext* context, const ::viam::robot::v1::UploadDataFromPathRequest* request, ::viam::robot::v1::UploadDataFromPathResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
     private:
      friend class Stub;
   ...
   private:
    ...
    ::grpc::ClientAsyncResponseReader< ::viam::robot::v1::GetPoseResponse>* AsyncGetPoseRaw(::grpc::ClientContext* context, const ::viam::robot::v1::GetPoseRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::viam::robot::v1::GetPoseResponse>* PrepareAsyncGetPoseRaw(::grpc::ClientContext* context, const ::viam::robot::v1::GetPoseRequest& request, ::grpc::CompletionQueue* cq) override;
    ...
    ::grpc::ClientAsyncResponseReader< ::viam::robot::v1::UploadDataFromPathResponse>* AsyncUploadDataFromPathRaw(::grpc::ClientContext* context, const ::viam::robot::v1::UploadDataFromPathRequest& request, ::grpc::CompletionQueue* cq) override;
    ::grpc::ClientAsyncResponseReader< ::viam::robot::v1::UploadDataFromPathResponse>* PrepareAsyncUploadDataFromPathRaw(::grpc::ClientContext* context, const ::viam::robot::v1::UploadDataFromPathRequest& request, ::grpc::CompletionQueue* cq) override;
    ...
    const ::grpc::internal::RpcMethod rpcmethod_UploadDataFromPath_;
  };
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    // GetPose returns the pose of a component in a desired referenceframe.
    virtual ::grpc::Status GetPose(::grpc::ServerContext* context, const ::viam::robot::v1::GetPoseRequest* request, ::viam::robot::v1::GetPoseResponse* response);
    // TransformPose returns a pose in one referenceframe in a desired referenceframe.
    ...
    // UploadDataFromPath uploads a file or directory from the robot to the cloud
    // via the configured data manager service.
    virtual ::grpc::Status UploadDataFromPath(::grpc::ServerContext* context, const ::viam::robot::v1::UploadDataFromPathRequest* request, ::viam::robot::v1::UploadDataFromPathResponse* response);
  };
  ...
  class WithAsyncMethod_GetPose : public BaseClass {
   ...
   public:
    ...
    // disable synchronous version of this method
    ::grpc::Status GetPose(::grpc::ServerContext* /*context*/, const ::viam::robot::v1::GetPoseRequest* /*request*/, ::viam::robot::v1::GetPoseResponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestGetPose(::grpc::ServerContext* context, ::viam::robot::v1::GetPoseRequest* request, ::grpc::ServerAsyncResponseWriter< ::viam::robot::v1::GetPoseResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
  ...
  template <class BaseClass>
  class WithAsyncMethod_UploadDataFromPath : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithAsyncMethod_UploadDataFromPath() {
      ::grpc::Service::MarkMethodAsync(25);
    }
    ~WithAsyncMethod_UploadDataFromPath() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status UploadDataFromPath(::grpc::ServerContext* /*context*/, const ::viam::robot::v1::UploadDataFromPathRequest* /*request*/, ::viam::robot::v1::UploadDataFromPathResponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestUploadDataFromPath(::grpc::ServerContext* context, ::viam::robot::v1::UploadDataFromPathRequest* request, ::grpc::ServerAsyncResponseWriter< ::viam::robot::v1::UploadDataFromPathResponse>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(25, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  typedef WithAsyncMethod_GetOperations<WithAsyncMethod_GetSessions<WithAsyncMethod_ResourceNames<WithAsyncMethod_ResourceRPCSubtypes<WithAsyncMethod_CancelOperation<WithAsyncMethod_BlockForOperation<WithAsyncMethod_GetModelsFromModules<WithAsyncMethod_GetStatus<WithAsyncMethod_StreamStatus<WithAsyncMethod_StopAll<WithAsyncMethod_StartSession<WithAsyncMethod_SendSessionHeartbeat<WithAsyncMethod_Log<WithAsyncMethod_GetCloudMetadata<WithAsyncMethod_RestartModule<WithAsyncMethod_Shutdown<WithAsyncMethod_GetMachineStatus<WithAsyncMethod_GetVersion<WithAsyncMethod_Tunnel<WithAsyncMethod_ListTunnels<WithAsyncMethod_FrameSystemConfig<WithAsyncMethod_GetPose<WithAsyncMethod_TransformPose<WithAsyncMethod_TransformPCD<WithAsyncMethod_SendTraces<WithAsyncMethod_UploadDataFromPath<Service > > > > > > > > > > > > > > > > > > > > > > > > > > AsyncService;
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithCallbackMethod_GetModelsFromModules : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithCallbackMethod_GetModelsFromModules() {
      ::grpc::Service::MarkMethodCallback(6,
          new ::grpc::internal::CallbackUnaryHandler< ::viam::robot::v1::GetModelsFromModulesRequest, ::viam::robot::v1::GetModelsFromModulesResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::viam::robot::v1::GetModelsFromModulesRequest* request, ::viam::robot::v1::GetModelsFromModulesResponse* response) { return this->GetModelsFromModules(context, request, response); }));}
    void SetMessageAllocatorFor_GetModelsFromModules(
        ::grpc::MessageAllocator< ::viam::robot::v1::GetModelsFromModulesRequest, ::viam::robot::v1::GetModelsFromModulesResponse>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(6);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::viam::robot::v1::GetModelsFromModulesRequest, ::viam::robot::v1::GetModelsFromModulesResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~WithCallbackMethod_GetModelsFromModules() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status GetModelsFromModules(::grpc::ServerContext* /*context*/, const ::viam::robot::v1::GetModelsFromModulesRequest* /*request*/, ::viam::robot::v1::GetModelsFromModulesResponse* /*response*/) override {
    ...
    virtual ::grpc::ServerUnaryReactor* GetModelsFromModules(
      ::grpc::CallbackServerContext* /*context*/, const ::viam::robot::v1::GetModelsFromModulesRequest* /*request*/, ::viam::robot::v1::GetModelsFromModulesResponse* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithCallbackMethod_GetMachineStatus : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithCallbackMethod_GetMachineStatus() {
      ::grpc::Service::MarkMethodCallback(16,
          new ::grpc::internal::CallbackUnaryHandler< ::viam::robot::v1::GetMachineStatusRequest, ::viam::robot::v1::GetMachineStatusResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::viam::robot::v1::GetMachineStatusRequest* request, ::viam::robot::v1::GetMachineStatusResponse* response) { return this->GetMachineStatus(context, request, response); }));}
    void SetMessageAllocatorFor_GetMachineStatus(
        ::grpc::MessageAllocator< ::viam::robot::v1::GetMachineStatusRequest, ::viam::robot::v1::GetMachineStatusResponse>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(16);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::viam::robot::v1::GetMachineStatusRequest, ::viam::robot::v1::GetMachineStatusResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~WithCallbackMethod_GetMachineStatus() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status GetMachineStatus(::grpc::ServerContext* /*context*/, const ::viam::robot::v1::GetMachineStatusRequest* /*request*/, ::viam::robot::v1::GetMachineStatusResponse* /*response*/) override {
    ...
    virtual ::grpc::ServerUnaryReactor* GetMachineStatus(
      ::grpc::CallbackServerContext* /*context*/, const ::viam::robot::v1::GetMachineStatusRequest* /*request*/, ::viam::robot::v1::GetMachineStatusResponse* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
   ...
   public:
    WithCallbackMethod_GetVersion() {
      ::grpc::Service::MarkMethodCallback(17,
          new ::grpc::internal::CallbackUnaryHandler< ::viam::robot::v1::GetVersionRequest, ::viam::robot::v1::GetVersionResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::viam::robot::v1::GetVersionRequest* request, ::viam::robot::v1::GetVersionResponse* response) { return this->GetVersion(context, request, response); }));}
    void SetMessageAllocatorFor_GetVersion(
        ::grpc::MessageAllocator< ::viam::robot::v1::GetVersionRequest, ::viam::robot::v1::GetVersionResponse>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(17);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::viam::robot::v1::GetVersionRequest, ::viam::robot::v1::GetVersionResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor* GetVersion(
      ::grpc::CallbackServerContext* /*context*/, const ::viam::robot::v1::GetVersionRequest* /*request*/, ::viam::robot::v1::GetVersionResponse* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
  class WithCallbackMethod_Tunnel : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithCallbackMethod_Tunnel() {
      ::grpc::Service::MarkMethodCallback(18,
          new ::grpc::internal::CallbackBidiHandler< ::viam::robot::v1::TunnelRequest, ::viam::robot::v1::TunnelResponse>(
            [this](
                   ::grpc::CallbackServerContext* context) { return this->Tunnel(context); }));
    }
    ~WithCallbackMethod_Tunnel() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status Tunnel(::grpc::ServerContext* /*context*/, ::grpc::ServerReaderWriter< ::viam::robot::v1::TunnelResponse, ::viam::robot::v1::TunnelRequest>* /*stream*/)  override {
  ...
  template <class BaseClass>
  class WithCallbackMethod_ListTunnels : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithCallbackMethod_ListTunnels() {
      ::grpc::Service::MarkMethodCallback(19,
          new ::grpc::internal::CallbackUnaryHandler< ::viam::robot::v1::ListTunnelsRequest, ::viam::robot::v1::ListTunnelsResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::viam::robot::v1::ListTunnelsRequest* request, ::viam::robot::v1::ListTunnelsResponse* response) { return this->ListTunnels(context, request, response); }));}
    void SetMessageAllocatorFor_ListTunnels(
        ::grpc::MessageAllocator< ::viam::robot::v1::ListTunnelsRequest, ::viam::robot::v1::ListTunnelsResponse>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(19);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::viam::robot::v1::ListTunnelsRequest, ::viam::robot::v1::ListTunnelsResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~WithCallbackMethod_ListTunnels() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ListTunnels(::grpc::ServerContext* /*context*/, const ::viam::robot::v1::ListTunnelsRequest* /*request*/, ::viam::robot::v1::ListTunnelsResponse* /*response*/) override {
    ...
    virtual ::grpc::ServerUnaryReactor* ListTunnels(
      ::grpc::CallbackServerContext* /*context*/, const ::viam::robot::v1::ListTunnelsRequest* /*request*/, ::viam::robot::v1::ListTunnelsResponse* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
   ...
   public:
    WithCallbackMethod_GetPose() {
      ::grpc::Service::MarkMethodCallback(21,
          new ::grpc::internal::CallbackUnaryHandler< ::viam::robot::v1::GetPoseRequest, ::viam::robot::v1::GetPoseResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::viam::robot::v1::GetPoseRequest* request, ::viam::robot::v1::GetPoseResponse* response) { return this->GetPose(context, request, response); }));}
    void SetMessageAllocatorFor_GetPose(
        ::grpc::MessageAllocator< ::viam::robot::v1::GetPoseRequest, ::viam::robot::v1::GetPoseResponse>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(21);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::viam::robot::v1::GetPoseRequest, ::viam::robot::v1::GetPoseResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor* GetPose(
      ::grpc::CallbackServerContext* /*context*/, const ::viam::robot::v1::GetPoseRequest* /*request*/, ::viam::robot::v1::GetPoseResponse* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithCallbackMethod_UploadDataFromPath : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithCallbackMethod_UploadDataFromPath() {
      ::grpc::Service::MarkMethodCallback(25,
          new ::grpc::internal::CallbackUnaryHandler< ::viam::robot::v1::UploadDataFromPathRequest, ::viam::robot::v1::UploadDataFromPathResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::viam::robot::v1::UploadDataFromPathRequest* request, ::viam::robot::v1::UploadDataFromPathResponse* response) { return this->UploadDataFromPath(context, request, response); }));}
    void SetMessageAllocatorFor_UploadDataFromPath(
        ::grpc::MessageAllocator< ::viam::robot::v1::UploadDataFromPathRequest, ::viam::robot::v1::UploadDataFromPathResponse>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(25);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::viam::robot::v1::UploadDataFromPathRequest, ::viam::robot::v1::UploadDataFromPathResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~WithCallbackMethod_UploadDataFromPath() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status UploadDataFromPath(::grpc::ServerContext* /*context*/, const ::viam::robot::v1::UploadDataFromPathRequest* /*request*/, ::viam::robot::v1::UploadDataFromPathResponse* /*response*/) override {
  ...
  template <class BaseClass>
  class WithGenericMethod_UploadDataFromPath : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithGenericMethod_UploadDataFromPath() {
      ::grpc::Service::MarkMethodGeneric(25);
    }
    ~WithGenericMethod_UploadDataFromPath() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status UploadDataFromPath(::grpc::ServerContext* /*context*/, const ::viam::robot::v1::UploadDataFromPathRequest* /*request*/, ::viam::robot::v1::UploadDataFromPathResponse* /*response*/) override {
  ...
  template <class BaseClass>
  class WithRawMethod_UploadDataFromPath : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawMethod_UploadDataFromPath() {
      ::grpc::Service::MarkMethodRaw(25);
    }
    ~WithRawMethod_UploadDataFromPath() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status UploadDataFromPath(::grpc::ServerContext* /*context*/, const ::viam::robot::v1::UploadDataFromPathRequest* /*request*/, ::viam::robot::v1::UploadDataFromPathResponse* /*response*/) override {
    ...
    void RequestUploadDataFromPath(::grpc::ServerContext* context, ::grpc::ByteBuffer* request, ::grpc::ServerAsyncResponseWriter< ::grpc::ByteBuffer>* response, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncUnary(25, context, request, response, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithRawCallbackMethod_GetModelsFromModules : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawCallbackMethod_GetModelsFromModules() {
      ::grpc::Service::MarkMethodRawCallback(6,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->GetModelsFromModules(context, request, response); }));
    }
    ~WithRawCallbackMethod_GetModelsFromModules() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status GetModelsFromModules(::grpc::ServerContext* /*context*/, const ::viam::robot::v1::GetModelsFromModulesRequest* /*request*/, ::viam::robot::v1::GetModelsFromModulesResponse* /*response*/) override {
  ...
  template <class BaseClass>
  class WithRawCallbackMethod_GetMachineStatus : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawCallbackMethod_GetMachineStatus() {
      ::grpc::Service::MarkMethodRawCallback(16,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->GetMachineStatus(context, request, response); }));
    }
    ~WithRawCallbackMethod_GetMachineStatus() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status GetMachineStatus(::grpc::ServerContext* /*context*/, const ::viam::robot::v1::GetMachineStatusRequest* /*request*/, ::viam::robot::v1::GetMachineStatusResponse* /*response*/) override {
  ...
  template <class BaseClass>
  class WithRawCallbackMethod_Tunnel : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawCallbackMethod_Tunnel() {
      ::grpc::Service::MarkMethodRawCallback(18,
          new ::grpc::internal::CallbackBidiHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context) { return this->Tunnel(context); }));
    }
    ~WithRawCallbackMethod_Tunnel() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status Tunnel(::grpc::ServerContext* /*context*/, ::grpc::ServerReaderWriter< ::viam::robot::v1::TunnelResponse, ::viam::robot::v1::TunnelRequest>* /*stream*/)  override {
  ...
  template <class BaseClass>
  class WithRawCallbackMethod_ListTunnels : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawCallbackMethod_ListTunnels() {
      ::grpc::Service::MarkMethodRawCallback(19,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->ListTunnels(context, request, response); }));
    }
    ~WithRawCallbackMethod_ListTunnels() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status ListTunnels(::grpc::ServerContext* /*context*/, const ::viam::robot::v1::ListTunnelsRequest* /*request*/, ::viam::robot::v1::ListTunnelsResponse* /*response*/) override {
  ...
  template <class BaseClass>
  class WithRawCallbackMethod_UploadDataFromPath : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawCallbackMethod_UploadDataFromPath() {
      ::grpc::Service::MarkMethodRawCallback(25,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->UploadDataFromPath(context, request, response); }));
    }
    ~WithRawCallbackMethod_UploadDataFromPath() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status UploadDataFromPath(::grpc::ServerContext* /*context*/, const ::viam::robot::v1::UploadDataFromPathRequest* /*request*/, ::viam::robot::v1::UploadDataFromPathResponse* /*response*/) override {
   ...
   public:
    WithStreamedUnaryMethod_GetPose() {
      ::grpc::Service::MarkMethodStreamed(21,
        new ::grpc::internal::StreamedUnaryHandler<
          ::viam::robot::v1::GetPoseRequest, ::viam::robot::v1::GetPoseResponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::viam::robot::v1::GetPoseRequest, ::viam::robot::v1::GetPoseResponse>* streamer) {
    ...
    // replace default version of method with streamed unary
    virtual ::grpc::Status StreamedGetPose(::grpc::ServerContext* context, ::grpc::ServerUnaryStreamer< ::viam::robot::v1::GetPoseRequest,::viam::robot::v1::GetPoseResponse>* server_unary_streamer) = 0;
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithStreamedUnaryMethod_UploadDataFromPath : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithStreamedUnaryMethod_UploadDataFromPath() {
      ::grpc::Service::MarkMethodStreamed(25,
        new ::grpc::internal::StreamedUnaryHandler<
          ::viam::robot::v1::UploadDataFromPathRequest, ::viam::robot::v1::UploadDataFromPathResponse>(
            [this](::grpc::ServerContext* context,
                   ::grpc::ServerUnaryStreamer<
                     ::viam::robot::v1::UploadDataFromPathRequest, ::viam::robot::v1::UploadDataFromPathResponse>* streamer) {
                       return this->StreamedUploadDataFromPath(context,
                         streamer);
                  }));
    }
    ~WithStreamedUnaryMethod_UploadDataFromPath() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable regular version of this method
    ::grpc::Status UploadDataFromPath(::grpc::ServerContext* /*context*/, const ::viam::robot::v1::UploadDataFromPathRequest* /*request*/, ::viam::robot::v1::UploadDataFromPathResponse* /*response*/) override {
