...
RobotService::Stub::Stub(const std::shared_ptr< ::grpc::ChannelInterface>& channel, const ::grpc::StubOptions& options)
  ...
  , rpcmethod_GetModelsFromModules_(RobotService_method_names[6], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetStatus_(RobotService_method_names[7], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_StreamStatus_(RobotService_method_names[8], options.suffix_for_stats(),::grpc::internal::RpcMethod::SERVER_STREAMING, channel)
  , rpcmethod_StopAll_(RobotService_method_names[9], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_StartSession_(RobotService_method_names[10], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_SendSessionHeartbeat_(RobotService_method_names[11], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_Log_(RobotService_method_names[12], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetCloudMetadata_(RobotService_method_names[13], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_RestartModule_(RobotService_method_names[14], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_Shutdown_(RobotService_method_names[15], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetMachineStatus_(RobotService_method_names[16], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_GetVersion_(RobotService_method_names[17], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_Tunnel_(RobotService_method_names[18], options.suffix_for_stats(),::grpc::internal::RpcMethod::BIDI_STREAMING, channel)
  , rpcmethod_ListTunnels_(RobotService_method_names[19], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
  , rpcmethod_FrameSystemConfig_(RobotService_method_names[20], options.suffix_for_stats(),::grpc::internal::RpcMethod::NORMAL_RPC, channel)
...
::grpc::Status RobotService::Stub::GetModelsFromModules(::grpc::ClientContext* context, const ::viam::robot::v1::GetModelsFromModulesRequest& request, ::viam::robot::v1::GetModelsFromModulesResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::viam::robot::v1::GetModelsFromModulesRequest, ::viam::robot::v1::GetModelsFromModulesResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_GetModelsFromModules_, context, request, response);
}

void RobotService::Stub::async::GetModelsFromModules(::grpc::ClientContext* context, const ::viam::robot::v1::GetModelsFromModulesRequest* request, ::viam::robot::v1::GetModelsFromModulesResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::viam::robot::v1::GetModelsFromModulesRequest, ::viam::robot::v1::GetModelsFromModulesResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetModelsFromModules_, context, request, response, std::move(f));
}

void RobotService::Stub::async::GetModelsFromModules(::grpc::ClientContext* context, const ::viam::robot::v1::GetModelsFromModulesRequest* request, ::viam::robot::v1::GetModelsFromModulesResponse* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetModelsFromModules_, context, request, response, reactor);
}
...
::grpc::ClientAsyncResponseReader< ::viam::robot::v1::GetModelsFromModulesResponse>* RobotService::Stub::PrepareAsyncGetModelsFromModulesRaw(::grpc::ClientContext* context, const ::viam::robot::v1::GetModelsFromModulesRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::viam::robot::v1::GetModelsFromModulesResponse, ::viam::robot::v1::GetModelsFromModulesRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_GetModelsFromModules_, context, request);
}
...
::grpc::ClientAsyncResponseReader< ::viam::robot::v1::GetModelsFromModulesResponse>* RobotService::Stub::AsyncGetModelsFromModulesRaw(::grpc::ClientContext* context, const ::viam::robot::v1::GetModelsFromModulesRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncGetModelsFromModulesRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
::grpc::Status RobotService::Stub::GetMachineStatus(::grpc::ClientContext* context, const ::viam::robot::v1::GetMachineStatusRequest& request, ::viam::robot::v1::GetMachineStatusResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::viam::robot::v1::GetMachineStatusRequest, ::viam::robot::v1::GetMachineStatusResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_GetMachineStatus_, context, request, response);
}

void RobotService::Stub::async::GetMachineStatus(::grpc::ClientContext* context, const ::viam::robot::v1::GetMachineStatusRequest* request, ::viam::robot::v1::GetMachineStatusResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::viam::robot::v1::GetMachineStatusRequest, ::viam::robot::v1::GetMachineStatusResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetMachineStatus_, context, request, response, std::move(f));
}

void RobotService::Stub::async::GetMachineStatus(::grpc::ClientContext* context, const ::viam::robot::v1::GetMachineStatusRequest* request, ::viam::robot::v1::GetMachineStatusResponse* response, ::grpc::ClientUnaryReactor* reactor) {
  ::grpc::internal::ClientCallbackUnaryFactory::Create< ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetMachineStatus_, context, request, response, reactor);
}
...
::grpc::ClientAsyncResponseReader< ::viam::robot::v1::GetMachineStatusResponse>* RobotService::Stub::PrepareAsyncGetMachineStatusRaw(::grpc::ClientContext* context, const ::viam::robot::v1::GetMachineStatusRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::viam::robot::v1::GetMachineStatusResponse, ::viam::robot::v1::GetMachineStatusRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_GetMachineStatus_, context, request);
}
...
::grpc::ClientAsyncResponseReader< ::viam::robot::v1::GetMachineStatusResponse>* RobotService::Stub::AsyncGetMachineStatusRaw(::grpc::ClientContext* context, const ::viam::robot::v1::GetMachineStatusRequest& request, ::grpc::CompletionQueue* cq) {
  auto* result =
    this->PrepareAsyncGetMachineStatusRaw(context, request, cq);
  result->StartCall();
  return result;
}
...
::grpc::Status RobotService::Stub::GetVersion(::grpc::ClientContext* context, const ::viam::robot::v1::GetVersionRequest& request, ::viam::robot::v1::GetVersionResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::viam::robot::v1::GetVersionRequest, ::viam::robot::v1::GetVersionResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_GetVersion_, context, request, response);
}

void RobotService::Stub::async::GetVersion(::grpc::ClientContext* context, const ::viam::robot::v1::GetVersionRequest* request, ::viam::robot::v1::GetVersionResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::viam::robot::v1::GetVersionRequest, ::viam::robot::v1::GetVersionResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetVersion_, context, request, response, std::move(f));
}

void RobotService::Stub::async::GetVersion(::grpc::ClientContext* context, const ::viam::robot::v1::GetVersionRequest* request, ::viam::robot::v1::GetVersionResponse* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::viam::robot::v1::GetVersionResponse>* RobotService::Stub::PrepareAsyncGetVersionRaw(::grpc::ClientContext* context, const ::viam::robot::v1::GetVersionRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::viam::robot::v1::GetVersionResponse, ::viam::robot::v1::GetVersionRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_GetVersion_, context, request);
}
...
::grpc::ClientReaderWriter< ::viam::robot::v1::TunnelRequest, ::viam::robot::v1::TunnelResponse>* RobotService::Stub::TunnelRaw(::grpc::ClientContext* context) {
  return ::grpc::internal::ClientReaderWriterFactory< ::viam::robot::v1::TunnelRequest, ::viam::robot::v1::TunnelResponse>::Create(channel_.get(), rpcmethod_Tunnel_, context);
}

void RobotService::Stub::async::Tunnel(::grpc::ClientContext* context, ::grpc::ClientBidiReactor< ::viam::robot::v1::TunnelRequest,::viam::robot::v1::TunnelResponse>* reactor) {
  ::grpc::internal::ClientCallbackReaderWriterFactory< ::viam::robot::v1::TunnelRequest,::viam::robot::v1::TunnelResponse>::Create(stub_->channel_.get(), stub_->rpcmethod_Tunnel_, context, reactor);
}
...
::grpc::ClientAsyncReaderWriter< ::viam::robot::v1::TunnelRequest, ::viam::robot::v1::TunnelResponse>* RobotService::Stub::AsyncTunnelRaw(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq, void* tag) {
  return ::grpc::internal::ClientAsyncReaderWriterFactory< ::viam::robot::v1::TunnelRequest, ::viam::robot::v1::TunnelResponse>::Create(channel_.get(), cq, rpcmethod_Tunnel_, context, true, tag);
}
...
::grpc::ClientAsyncReaderWriter< ::viam::robot::v1::TunnelRequest, ::viam::robot::v1::TunnelResponse>* RobotService::Stub::PrepareAsyncTunnelRaw(::grpc::ClientContext* context, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncReaderWriterFactory< ::viam::robot::v1::TunnelRequest, ::viam::robot::v1::TunnelResponse>::Create(channel_.get(), cq, rpcmethod_Tunnel_, context, false, nullptr);
}
...
::grpc::Status RobotService::Stub::ListTunnels(::grpc::ClientContext* context, const ::viam::robot::v1::ListTunnelsRequest& request, ::viam::robot::v1::ListTunnelsResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::viam::robot::v1::ListTunnelsRequest, ::viam::robot::v1::ListTunnelsResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_ListTunnels_, context, request, response);
}

void RobotService::Stub::async::ListTunnels(::grpc::ClientContext* context, const ::viam::robot::v1::ListTunnelsRequest* request, ::viam::robot::v1::ListTunnelsResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::viam::robot::v1::ListTunnelsRequest, ::viam::robot::v1::ListTunnelsResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_ListTunnels_, context, request, response, std::move(f));
}

void RobotService::Stub::async::ListTunnels(::grpc::ClientContext* context, const ::viam::robot::v1::ListTunnelsRequest* request, ::viam::robot::v1::ListTunnelsResponse* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::viam::robot::v1::ListTunnelsResponse>* RobotService::Stub::PrepareAsyncListTunnelsRaw(::grpc::ClientContext* context, const ::viam::robot::v1::ListTunnelsRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::viam::robot::v1::ListTunnelsResponse, ::viam::robot::v1::ListTunnelsRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_ListTunnels_, context, request);
}
...
::grpc::Status RobotService::Stub::GetPose(::grpc::ClientContext* context, const ::viam::robot::v1::GetPoseRequest& request, ::viam::robot::v1::GetPoseResponse* response) {
  return ::grpc::internal::BlockingUnaryCall< ::viam::robot::v1::GetPoseRequest, ::viam::robot::v1::GetPoseResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_GetPose_, context, request, response);
}

void RobotService::Stub::async::GetPose(::grpc::ClientContext* context, const ::viam::robot::v1::GetPoseRequest* request, ::viam::robot::v1::GetPoseResponse* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::viam::robot::v1::GetPoseRequest, ::viam::robot::v1::GetPoseResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetPose_, context, request, response, std::move(f));
}

void RobotService::Stub::async::GetPose(::grpc::ClientContext* context, const ::viam::robot::v1::GetPoseRequest* request, ::viam::robot::v1::GetPoseResponse* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::viam::robot::v1::GetPoseResponse>* RobotService::Stub::PrepareAsyncGetPoseRaw(::grpc::ClientContext* context, const ::viam::robot::v1::GetPoseRequest& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::viam::robot::v1::GetPoseResponse, ::viam::robot::v1::GetPoseRequest, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_GetPose_, context, request);
}
...
RobotService::Service::Service() {
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< RobotService::Service, ::viam::robot::v1::GetModelsFromModulesRequest, ::viam::robot::v1::GetModelsFromModulesResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](RobotService::Service* service,
             ::grpc::ServerContext* ctx,
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< RobotService::Service, ::viam::robot::v1::GetMachineStatusRequest, ::viam::robot::v1::GetMachineStatusResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](RobotService::Service* service,
             ::grpc::ServerContext* ctx,
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< RobotService::Service, ::viam::robot::v1::GetVersionRequest, ::viam::robot::v1::GetVersionResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](RobotService::Service* service,
             ::grpc::ServerContext* ctx,
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::BidiStreamingHandler< RobotService::Service, ::viam::robot::v1::TunnelRequest, ::viam::robot::v1::TunnelResponse>(
          [](RobotService::Service* service,
             ::grpc::ServerContext* ctx,
             ::grpc::ServerReaderWriter<::viam::robot::v1::TunnelResponse,
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< RobotService::Service, ::viam::robot::v1::ListTunnelsRequest, ::viam::robot::v1::ListTunnelsResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](RobotService::Service* service,
             ::grpc::ServerContext* ctx,
  ...
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      ::grpc::internal::RpcMethod::NORMAL_RPC,
      new ::grpc::internal::RpcMethodHandler< RobotService::Service, ::viam::robot::v1::GetPoseRequest, ::viam::robot::v1::GetPoseResponse, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](RobotService::Service* service,
             ::grpc::ServerContext* ctx,
