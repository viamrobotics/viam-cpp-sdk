...
void Span_Link::set_trace_state(ArgT0&& arg0, ArgT... args) {
 ...
 trace_state_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Span_Link::_internal_set_trace_state(const std::string& value) {
  ...
  trace_state_.Set(value, GetArenaForAllocation());
}
inline std::string* Span_Link::_internal_mutable_trace_state() {
  
  return trace_state_.Mutable(GetArenaForAllocation());
}
...
inline void Span_Link::set_allocated_trace_state(std::string* trace_state) {
  ...
  trace_state_.SetAllocated(trace_state, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (trace_state_.IsDefault()) {
...
void Span::set_parent_span_id(ArgT0&& arg0, ArgT... args) {
 ...
 parent_span_id_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Span::_internal_set_parent_span_id(const std::string& value) {
  ...
  parent_span_id_.Set(value, GetArenaForAllocation());
}
inline std::string* Span::_internal_mutable_parent_span_id() {
  
  return parent_span_id_.Mutable(GetArenaForAllocation());
}
inline std::string* Span::release_parent_span_id() {
  ...
  return parent_span_id_.Release();
}
inline void Span::set_allocated_parent_span_id(std::string* parent_span_id) {
  ...
  parent_span_id_.SetAllocated(parent_span_id, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (parent_span_id_.IsDefault()) {
