...
inline void AnyValue::set_bytes_value(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_bytes_value()) {
    clear_value();
    set_has_bytes_value();
    value_.bytes_value_.InitDefault();
  }
  value_.bytes_value_.SetBytes( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void AnyValue::_internal_set_bytes_value(const std::string& value) {
  ...
  value_.bytes_value_.Set(value, GetArenaForAllocation());
}
inline std::string* AnyValue::_internal_mutable_bytes_value() {
  ...
  return value_.bytes_value_.Mutable(      GetArenaForAllocation());
}
inline std::string* AnyValue::release_bytes_value() {
  ...
  if (_internal_has_bytes_value()) {
    clear_has_value();
    return value_.bytes_value_.Release();
  } else {
    return nullptr;
  }
}
inline void AnyValue::set_allocated_bytes_value(std::string* bytes_value) {
  ...
  if (bytes_value != nullptr) {
    set_has_bytes_value();
    value_.bytes_value_.InitAllocated(bytes_value, GetArenaForAllocation());
  }
...
inline void EntityRef::set_id_keys(int index, std::string&& value) {
  id_keys_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:opentelemetry.proto.common.v1.EntityRef.id_keys)
}
...
inline void EntityRef::add_id_keys(const char* value, size_t size) {
  id_keys_.Add()->assign(reinterpret_cast<const char*>(value), size);
...
inline const std::string& EntityRef::_internal_description_keys(int index) const {
  return description_keys_.Get(index);
}
...
inline std::string* EntityRef::mutable_description_keys(int index) {
  ...
  return description_keys_.Mutable(index);
}
inline void EntityRef::set_description_keys(int index, const std::string& value) {
  description_keys_.Mutable(index)->assign(value);
...
inline void EntityRef::set_description_keys(int index, std::string&& value) {
  description_keys_.Mutable(index)->assign(std::move(value));
  // @@protoc_insertion_point(field_set:opentelemetry.proto.common.v1.EntityRef.description_keys)
}
...
inline void EntityRef::set_description_keys(int index, const char* value, size_t size) {
  description_keys_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
...
inline void EntityRef::add_description_keys(std::string&& value) {
  description_keys_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:opentelemetry.proto.common.v1.EntityRef.description_keys)
}
...
inline void EntityRef::add_description_keys(const char* value, size_t size) {
  description_keys_.Add()->assign(reinterpret_cast<const char*>(value), size);
