...
class DiscoveryService final {
 public:
   ...
   public:
    ...
    class experimental_async_interface {
     public:
      ...
      virtual void DiscoverResources(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::viam::service::discovery::v1::DiscoverResourcesResponse* response, std::function<void(::grpc::Status)>) = 0;
      ...
      #else
      virtual void DiscoverResources(::grpc::ClientContext* context, const ::viam::service::discovery::v1::DiscoverResourcesRequest* request, ::viam::service::discovery::v1::DiscoverResourcesResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      virtual void DiscoverResources(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::viam::service::discovery::v1::DiscoverResourcesResponse* response, ::grpc::ClientUnaryReactor* reactor) = 0;
      #else
      virtual void DiscoverResources(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::viam::service::discovery::v1::DiscoverResourcesResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) = 0;
      #endif
      // DoCommand sends/receives arbitrary commands
   ...
   public:
    ...
    class experimental_async final :
     ...
     public:
      ...
      void DiscoverResources(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::viam::service::discovery::v1::DiscoverResourcesResponse* response, std::function<void(::grpc::Status)>) override;
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ...
      #else
      void DiscoverResources(::grpc::ClientContext* context, const ::viam::service::discovery::v1::DiscoverResourcesRequest* request, ::viam::service::discovery::v1::DiscoverResourcesResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
      #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      void DiscoverResources(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::viam::service::discovery::v1::DiscoverResourcesResponse* response, ::grpc::ClientUnaryReactor* reactor) override;
      #else
      void DiscoverResources(::grpc::ClientContext* context, const ::grpc::ByteBuffer* request, ::viam::service::discovery::v1::DiscoverResourcesResponse* response, ::grpc::experimental::ClientUnaryReactor* reactor) override;
      #endif
  ...
  template <class BaseClass>
  class ExperimentalWithCallbackMethod_DiscoverResources : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithCallbackMethod_DiscoverResources() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodCallback(0,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::viam::service::discovery::v1::DiscoverResourcesRequest, ::viam::service::discovery::v1::DiscoverResourcesResponse>(
            [this](
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
    ...
    #endif
                     context, const ::viam::service::discovery::v1::DiscoverResourcesRequest* request, ::viam::service::discovery::v1::DiscoverResourcesResponse* response) { return this->DiscoverResources(context, request, response); }));}
    void SetMessageAllocatorFor_DiscoverResources(
        ::grpc::experimental::MessageAllocator< ::viam::service::discovery::v1::DiscoverResourcesRequest, ::viam::service::discovery::v1::DiscoverResourcesResponse>* allocator) {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(0);
    #else
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::experimental().GetHandler(0);
    #endif
      static_cast<::grpc_impl::internal::CallbackUnaryHandler< ::viam::service::discovery::v1::DiscoverResourcesRequest, ::viam::service::discovery::v1::DiscoverResourcesResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ~ExperimentalWithCallbackMethod_DiscoverResources() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status DiscoverResources(::grpc::ServerContext* /*context*/, const ::viam::service::discovery::v1::DiscoverResourcesRequest* /*request*/, ::viam::service::discovery::v1::DiscoverResourcesResponse* /*response*/) override {
    ...
    virtual ::grpc::ServerUnaryReactor* DiscoverResources(
      ::grpc::CallbackServerContext* /*context*/, const ::viam::service::discovery::v1::DiscoverResourcesRequest* /*request*/, ::viam::service::discovery::v1::DiscoverResourcesResponse* /*response*/)
    #else
    virtual ::grpc::experimental::ServerUnaryReactor* DiscoverResources(
      ::grpc::experimental::CallbackServerContext* /*context*/, const ::viam::service::discovery::v1::DiscoverResourcesRequest* /*request*/, ::viam::service::discovery::v1::DiscoverResourcesResponse* /*response*/)
    #endif
      { return nullptr; }
  };
  template <class BaseClass>
  ...
  #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
  typedef ExperimentalWithCallbackMethod_DiscoverResources<ExperimentalWithCallbackMethod_DoCommand<Service > > CallbackService;
  #endif

  typedef ExperimentalWithCallbackMethod_DiscoverResources<ExperimentalWithCallbackMethod_DoCommand<Service > > ExperimentalCallbackService;
  template <class BaseClass>
  ...
  template <class BaseClass>
  class ExperimentalWithRawCallbackMethod_DiscoverResources : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    ExperimentalWithRawCallbackMethod_DiscoverResources() {
    #ifdef GRPC_CALLBACK_API_NONEXPERIMENTAL
      ::grpc::Service::
    #else
      ::grpc::Service::experimental().
        ...
        MarkMethodRawCallback(0,
          new ::grpc_impl::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ...
                   ::grpc::experimental::CallbackServerContext*
    #endif
                     context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->DiscoverResources(context, request, response); }));
    }
    ~ExperimentalWithRawCallbackMethod_DiscoverResources() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status DiscoverResources(::grpc::ServerContext* /*context*/, const ::viam::service::discovery::v1::DiscoverResourcesRequest* /*request*/, ::viam::service::discovery::v1::DiscoverResourcesResponse* /*response*/) override {
