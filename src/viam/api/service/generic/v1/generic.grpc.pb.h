...
class GenericService final {
 public:
  ...
  typedef WithAsyncMethod_DoCommand<WithAsyncMethod_GetStatus<Service > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_DoCommand<WithCallbackMethod_GetStatus<Service > > CallbackService;
