...
class VideoService final {
 public:
  ...
  typedef WithAsyncMethod_GetVideo<WithAsyncMethod_DoCommand<WithAsyncMethod_GetStatus<Service > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_GetVideo<WithCallbackMethod_DoCommand<WithCallbackMethod_GetStatus<Service > > > CallbackService;
  ...
  typedef WithStreamedUnaryMethod_DoCommand<WithStreamedUnaryMethod_GetStatus<Service > > StreamedUnaryService;
  template <class BaseClass>
  ...
  typedef WithSplitStreamingMethod_GetVideo<WithStreamedUnaryMethod_DoCommand<WithStreamedUnaryMethod_GetStatus<Service > > > StreamedService;
};
