...
class SLAMService final {
 public:
  ...
  typedef WithAsyncMethod_GetPosition<WithAsyncMethod_GetPointCloudMap<WithAsyncMethod_GetInternalState<WithAsyncMethod_GetProperties<WithAsyncMethod_DoCommand<WithAsyncMethod_GetStatus<Service > > > > > > AsyncService;
  template <class BaseClass>
   ...
   public:
    WithCallbackMethod_GetProperties() {
      ::grpc::Service::MarkMethodCallback(3,
          new ::grpc::internal::CallbackUnaryHandler< ::viam::service::slam::v1::GetPropertiesRequest, ::viam::service::slam::v1::GetPropertiesResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::viam::service::slam::v1::GetPropertiesRequest* request, ::viam::service::slam::v1::GetPropertiesResponse* response) { return this->GetProperties(context, request, response); }));}
    void SetMessageAllocatorFor_GetProperties(
        ::grpc::MessageAllocator< ::viam::service::slam::v1::GetPropertiesRequest, ::viam::service::slam::v1::GetPropertiesResponse>* allocator) {
      ::grpc::internal::MethodHandler* const handler = ::grpc::Service::GetHandler(3);
      static_cast<::grpc::internal::CallbackUnaryHandler< ::viam::service::slam::v1::GetPropertiesRequest, ::viam::service::slam::v1::GetPropertiesResponse>*>(handler)
              ->SetMessageAllocator(allocator);
    }
    ...
    virtual ::grpc::ServerUnaryReactor* GetProperties(
      ::grpc::CallbackServerContext* /*context*/, const ::viam::service::slam::v1::GetPropertiesRequest* /*request*/, ::viam::service::slam::v1::GetPropertiesResponse* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_GetPosition<WithCallbackMethod_GetPointCloudMap<WithCallbackMethod_GetInternalState<WithCallbackMethod_GetProperties<WithCallbackMethod_DoCommand<WithCallbackMethod_GetStatus<Service > > > > > > CallbackService;
  ...
  typedef WithStreamedUnaryMethod_GetPosition<WithStreamedUnaryMethod_GetProperties<WithStreamedUnaryMethod_DoCommand<WithStreamedUnaryMethod_GetStatus<Service > > > > StreamedUnaryService;
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_GetPosition<WithSplitStreamingMethod_GetPointCloudMap<WithSplitStreamingMethod_GetInternalState<WithStreamedUnaryMethod_GetProperties<WithStreamedUnaryMethod_DoCommand<WithStreamedUnaryMethod_GetStatus<Service > > > > > > StreamedService;
};
