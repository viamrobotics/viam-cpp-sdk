...
class ShellService final {
 public:
  ...
  typedef WithAsyncMethod_Shell<WithAsyncMethod_CopyFilesToMachine<WithAsyncMethod_CopyFilesFromMachine<WithAsyncMethod_DoCommand<WithAsyncMethod_GetStatus<Service > > > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_Shell<WithCallbackMethod_CopyFilesToMachine<WithCallbackMethod_CopyFilesFromMachine<WithCallbackMethod_DoCommand<WithCallbackMethod_GetStatus<Service > > > > > CallbackService;
  ...
  typedef WithStreamedUnaryMethod_DoCommand<WithStreamedUnaryMethod_GetStatus<Service > > StreamedService;
};
