...
PROTOBUF_CONSTEXPR ReadyRequest::ReadyRequest(
  ...
  , /*decltype(_impl_.webrtc_offer_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
  , /*decltype(_impl_._cached_size_)*/{}} {}
...
PROTOBUF_CONSTEXPR ReadyResponse::ReadyResponse(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.webrtc_answer_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
...
PROTOBUF_CONSTEXPR ValidateConfigResponse::ValidateConfigResponse(
    ::_pbi::ConstantInitialized): _impl_{
    /*decltype(_impl_.dependencies_)*/{}
  , /*decltype(_impl_.optional_dependencies_)*/{}
  , /*decltype(_impl_._cached_size_)*/{}} {}
...
ReadyRequest::ReadyRequest(const ReadyRequest& from)
  ...
  _impl_.webrtc_offer_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.webrtc_offer_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_webrtc_offer().empty()) {
    _this->_impl_.webrtc_offer_.Set(from._internal_webrtc_offer(), 
      _this->GetArenaForAllocation());
  }
...
void ReadyRequest::InternalSwap(ReadyRequest* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.webrtc_offer_, lhs_arena,
      &other->_impl_.webrtc_offer_, rhs_arena
  );
}
...
ReadyResponse::ReadyResponse(const ReadyResponse& from)
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.webrtc_answer_){}
    , decltype(_impl_.handlermap_){nullptr}
    , decltype(_impl_.ready_){}
    , /*decltype(_impl_._cached_size_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  _impl_.webrtc_answer_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.webrtc_answer_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_webrtc_answer().empty()) {
    _this->_impl_.webrtc_answer_.Set(from._internal_webrtc_answer(), 
      _this->GetArenaForAllocation());
  }
...
void ReadyResponse::InternalSwap(ReadyResponse* other) {
  ...
  _internal_metadata_.InternalSwap(&other->_internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.webrtc_answer_, lhs_arena,
      &other->_impl_.webrtc_answer_, rhs_arena
  );
...
void ValidateConfigRequest::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
...
ValidateConfigResponse::ValidateConfigResponse(const ValidateConfigResponse& from)
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.dependencies_){from._impl_.dependencies_}
    , decltype(_impl_.optional_dependencies_){from._impl_.optional_dependencies_}
    , /*decltype(_impl_._cached_size_)*/{}};
...
inline void ValidateConfigResponse::SharedCtor(
  ...
  new (&_impl_) Impl_{
      decltype(_impl_.dependencies_){arena}
    , decltype(_impl_.optional_dependencies_){arena}
    , /*decltype(_impl_._cached_size_)*/{}
  };
}
...
inline void ValidateConfigResponse::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.dependencies_.~RepeatedPtrField();
  _impl_.optional_dependencies_.~RepeatedPtrField();
}
...
// @@protoc_insertion_point(message_byte_size_start:viam.module.v1.ValidateConfigResponse)
  ...
  // repeated string optional_dependencies = 2 [json_name = "optionalDependencies"];
  total_size += 1 *
      ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(_impl_.optional_dependencies_.size());
  for (int i = 0, n = _impl_.optional_dependencies_.size(); i < n; i++) {
    total_size += ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
      _impl_.optional_dependencies_.Get(i));
  }
...
void ValidateConfigResponse::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.dependencies_.MergeFrom(from._impl_.dependencies_);
  _this->_impl_.optional_dependencies_.MergeFrom(from._impl_.optional_dependencies_);
  _this->_internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
}
