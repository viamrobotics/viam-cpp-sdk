...
void QuotaFailure_Violation::set_subject(ArgT0&& arg0, ArgT... args) {
 ...
 subject_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void QuotaFailure_Violation::_internal_set_subject(const std::string& value) {
  ...
  subject_.Set(value, GetArenaForAllocation());
}
inline std::string* QuotaFailure_Violation::_internal_mutable_subject() {
  
  return subject_.Mutable(GetArenaForAllocation());
}
...
inline void QuotaFailure_Violation::set_allocated_subject(std::string* subject) {
  ...
  subject_.SetAllocated(subject, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (subject_.IsDefault()) {
...
inline bool BadRequest_FieldViolation::_internal_has_localized_message() const {
  return this != internal_default_instance() && localized_message_ != nullptr;
}
...
inline const ::google::rpc::LocalizedMessage& BadRequest_FieldViolation::_internal_localized_message() const {
  const ::google::rpc::LocalizedMessage* p = localized_message_;
...
inline void BadRequest_FieldViolation::unsafe_arena_set_allocated_localized_message(
    ::google::rpc::LocalizedMessage* localized_message) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(localized_message_);
  }
  localized_message_ = localized_message;
...
inline ::google::rpc::LocalizedMessage* BadRequest_FieldViolation::release_localized_message() {
  ...
  ::google::rpc::LocalizedMessage* temp = localized_message_;
  localized_message_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
void RequestInfo::set_serving_data(ArgT0&& arg0, ArgT... args) {
 ...
 serving_data_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void RequestInfo::_internal_set_serving_data(const std::string& value) {
  ...
  serving_data_.Set(value, GetArenaForAllocation());
}
inline std::string* RequestInfo::_internal_mutable_serving_data() {
  
  return serving_data_.Mutable(GetArenaForAllocation());
}
...
inline void RequestInfo::set_allocated_serving_data(std::string* serving_data) {
  ...
  serving_data_.SetAllocated(serving_data, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (serving_data_.IsDefault()) {
...
void ResourceInfo::set_resource_name(ArgT0&& arg0, ArgT... args) {
 ...
 resource_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ResourceInfo::_internal_set_resource_name(const std::string& value) {
  ...
  resource_name_.Set(value, GetArenaForAllocation());
}
inline std::string* ResourceInfo::_internal_mutable_resource_name() {
  
  return resource_name_.Mutable(GetArenaForAllocation());
}
...
inline void ResourceInfo::set_allocated_resource_name(std::string* resource_name) {
  ...
  resource_name_.SetAllocated(resource_name, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (resource_name_.IsDefault()) {
