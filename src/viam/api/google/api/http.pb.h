...
inline void HttpRule::set_get(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_get()) {
    clear_pattern();
    set_has_get();
    pattern_.get_.InitDefault();
  }
  pattern_.get_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void HttpRule::_internal_set_get(const std::string& value) {
  ...
  pattern_.get_.Set(value, GetArenaForAllocation());
}
...
inline void HttpRule::set_allocated_get(std::string* get) {
  ...
  if (get != nullptr) {
    set_has_get();
    pattern_.get_.InitAllocated(get, GetArenaForAllocation());
  }
...
inline void HttpRule::set_put(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_put()) {
    clear_pattern();
    set_has_put();
    pattern_.put_.InitDefault();
  }
  pattern_.put_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void HttpRule::_internal_set_put(const std::string& value) {
  ...
  pattern_.put_.Set(value, GetArenaForAllocation());
}
...
inline void HttpRule::set_allocated_put(std::string* put) {
  ...
  if (put != nullptr) {
    set_has_put();
    pattern_.put_.InitAllocated(put, GetArenaForAllocation());
  }
...
inline void HttpRule::set_post(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_post()) {
    clear_pattern();
    set_has_post();
    pattern_.post_.InitDefault();
  }
  pattern_.post_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void HttpRule::_internal_set_post(const std::string& value) {
  ...
  pattern_.post_.Set(value, GetArenaForAllocation());
}
inline std::string* HttpRule::_internal_mutable_post() {
  ...
  return pattern_.post_.Mutable(      GetArenaForAllocation());
}
...
inline void HttpRule::set_allocated_post(std::string* post) {
  ...
  if (post != nullptr) {
    set_has_post();
    pattern_.post_.InitAllocated(post, GetArenaForAllocation());
  }
...
inline void HttpRule::set_delete_(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_delete_()) {
    clear_pattern();
    set_has_delete_();
    pattern_.delete__.InitDefault();
  }
  pattern_.delete__.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void HttpRule::_internal_set_delete_(const std::string& value) {
  ...
  pattern_.delete__.Set(value, GetArenaForAllocation());
}
...
inline void HttpRule::set_allocated_delete_(std::string* delete_) {
  ...
  if (delete_ != nullptr) {
    set_has_delete_();
    pattern_.delete__.InitAllocated(delete_, GetArenaForAllocation());
  }
...
inline void HttpRule::set_patch(ArgT0&& arg0, ArgT... args) {
  if (!_internal_has_patch()) {
    clear_pattern();
    set_has_patch();
    pattern_.patch_.InitDefault();
  }
  pattern_.patch_.Set( static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void HttpRule::_internal_set_patch(const std::string& value) {
  ...
  pattern_.patch_.Set(value, GetArenaForAllocation());
}
...
inline void HttpRule::set_allocated_patch(std::string* patch) {
  ...
  if (patch != nullptr) {
    set_has_patch();
    pattern_.patch_.InitAllocated(patch, GetArenaForAllocation());
  }
...
void HttpRule::set_response_body(ArgT0&& arg0, ArgT... args) {
 ...
 response_body_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void HttpRule::_internal_set_response_body(const std::string& value) {
  ...
  response_body_.Set(value, GetArenaForAllocation());
}
inline std::string* HttpRule::_internal_mutable_response_body() {
  
  return response_body_.Mutable(GetArenaForAllocation());
}
...
inline void HttpRule::set_allocated_response_body(std::string* response_body) {
  ...
  response_body_.SetAllocated(response_body, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (response_body_.IsDefault()) {
