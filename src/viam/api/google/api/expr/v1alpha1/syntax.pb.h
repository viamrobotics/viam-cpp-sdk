...
void Expr_Comprehension::set_iter_var2(ArgT0&& arg0, ArgT... args) {
 ...
 iter_var2_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void Expr_Comprehension::set_allocated_iter_var2(std::string* iter_var2) {
  ...
  iter_var2_.SetAllocated(iter_var2, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (iter_var2_.IsDefault()) {
