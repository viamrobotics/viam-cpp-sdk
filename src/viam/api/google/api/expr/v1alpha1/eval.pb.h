...
inline ::google::api::expr::v1alpha1::Value* ExprValue::_internal_mutable_value() {
  if (kind_case() != kValue) {
    clear_kind();
    set_has_value();
    _impl_.kind_.value_ = CreateMaybeMessage<::google::api::expr::v1alpha1::Value>(GetArena());
  }
...
inline ::google::api::expr::v1alpha1::ErrorSet* ExprValue::_internal_mutable_error() {
  if (kind_case() != kError) {
    clear_kind();
    set_has_error();
    _impl_.kind_.error_ = CreateMaybeMessage<::google::api::expr::v1alpha1::ErrorSet>(GetArena());
  }
...
inline ::google::api::expr::v1alpha1::UnknownSet* ExprValue::_internal_mutable_unknown() {
  if (kind_case() != kUnknown) {
    clear_kind();
    set_has_unknown();
    _impl_.kind_.unknown_ = CreateMaybeMessage<::google::api::expr::v1alpha1::UnknownSet>(GetArena());
  }
...
inline const ::google::protobuf::RepeatedField<::int64_t>& UnknownSet::_internal_exprs()
    const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
