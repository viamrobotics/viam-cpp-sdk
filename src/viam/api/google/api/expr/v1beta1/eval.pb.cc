...
const ::uint32_t TableStruct_google_2fapi_2fexpr_2fv1beta1_2feval_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    protodesc_cold) = {
...
const ::_pbi::DescriptorTable descriptor_table_google_2fapi_2fexpr_2fv1beta1_2feval_2eproto = {
    ...
    file_level_metadata_google_2fapi_2fexpr_2fv1beta1_2feval_2eproto,
...
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_google_2fapi_2fexpr_2fv1beta1_2feval_2eproto(&descriptor_table_google_2fapi_2fexpr_2fv1beta1_2feval_2eproto);
namespace google {
namespace api {
namespace expr {
namespace v1beta1 {
...
class EvalState_Result::_Internal {
 public:
  using HasBits = decltype(std::declval<EvalState_Result>()._impl_._has_bits_);
...
const ::google::api::expr::v1beta1::IdRef& EvalState_Result::_Internal::expr(const EvalState_Result* msg) {
...
EvalState_Result::EvalState_Result(
  ...
  _impl_.expr_ = (cached_has_bits & 0x00000001u)
                ? CreateMaybeMessage<::google::api::expr::v1beta1::IdRef>(arena, *from._impl_.expr_)
                : nullptr;
...
const ::google::api::expr::v1beta1::Value& ExprValue::_Internal::value(const ExprValue* msg) {
  return *msg->_impl_.kind_.value_;
}
const ::google::api::expr::v1beta1::ErrorSet& ExprValue::_Internal::error(const ExprValue* msg) {
  return *msg->_impl_.kind_.error_;
}
const ::google::api::expr::v1beta1::UnknownSet& ExprValue::_Internal::unknown(const ExprValue* msg) {
...
ExprValue::ExprValue(
  ...
  switch (kind_case()) {
    case KIND_NOT_SET:
      break;
      case kValue:
        _impl_.kind_.value_ = CreateMaybeMessage<::google::api::expr::v1beta1::Value>(arena, *from._impl_.kind_.value_);
        break;
      case kError:
        _impl_.kind_.error_ = CreateMaybeMessage<::google::api::expr::v1beta1::ErrorSet>(arena, *from._impl_.kind_.error_);
        break;
      case kUnknown:
        _impl_.kind_.unknown_ = CreateMaybeMessage<::google::api::expr::v1beta1::UnknownSet>(arena, *from._impl_.kind_.unknown_);
        break;
  }
...
const char* IdRef::_InternalParse(
    const char* ptr, ::_pbi::ParseContext* ctx) {
  ptr = ::_pbi::TcParser::ParseLoop(this, ptr, ctx, &_table_.header);
  return ptr;
}
...
const ::google::protobuf::Message::ClassData IdRef::_class_data_ = {
    IdRef::MergeImpl,
    nullptr,  // OnDemandRegisterArenaDtor
};
const ::google::protobuf::Message::ClassData* IdRef::GetClassData() const {
  return &_class_data_;
}

void IdRef::MergeImpl(::google::protobuf::Message& to_msg, const ::google::protobuf::Message& from_msg) {
...
PROTOBUF_NOINLINE bool IdRef::IsInitialized() const {
  return true;
}

::_pbi::CachedSize* IdRef::AccessCachedSize() const {
  return &_impl_._cached_size_;
}
