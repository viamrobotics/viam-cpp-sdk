 ...
 public:
  ...
  class StubInterface {
   public:
    ...
    // where the first packet must be the UploadMetadata.
    std::unique_ptr< ::grpc::ClientWriterInterface< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>> StreamingDataCaptureUpload(::grpc::ClientContext* context, ::viam::app::datasync::v1::StreamingDataCaptureUploadResponse* response) {
      return std::unique_ptr< ::grpc::ClientWriterInterface< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>>(StreamingDataCaptureUploadRaw(context, response));
    }
    std::unique_ptr< ::grpc::ClientAsyncWriterInterface< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>> AsyncStreamingDataCaptureUpload(::grpc::ClientContext* context, ::viam::app::datasync::v1::StreamingDataCaptureUploadResponse* response, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncWriterInterface< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>>(AsyncStreamingDataCaptureUploadRaw(context, response, cq, tag));
    }
    std::unique_ptr< ::grpc::ClientAsyncWriterInterface< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>> PrepareAsyncStreamingDataCaptureUpload(::grpc::ClientContext* context, ::viam::app::datasync::v1::StreamingDataCaptureUploadResponse* response, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncWriterInterface< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>>(PrepareAsyncStreamingDataCaptureUploadRaw(context, response, cq));
    }
    class async_interface {
     public:
      ...
      // StreamingDataCaptureUpload uploads the streaming contents and metadata for streaming binary (image + file) data,
      // where the first packet must be the UploadMetadata.
      virtual void StreamingDataCaptureUpload(::grpc::ClientContext* context, ::viam::app::datasync::v1::StreamingDataCaptureUploadResponse* response, ::grpc::ClientWriteReactor< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>* reactor) = 0;
    };
   ...
   private:
    ...
    virtual ::grpc::ClientWriterInterface< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>* StreamingDataCaptureUploadRaw(::grpc::ClientContext* context, ::viam::app::datasync::v1::StreamingDataCaptureUploadResponse* response) = 0;
    virtual ::grpc::ClientAsyncWriterInterface< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>* AsyncStreamingDataCaptureUploadRaw(::grpc::ClientContext* context, ::viam::app::datasync::v1::StreamingDataCaptureUploadResponse* response, ::grpc::CompletionQueue* cq, void* tag) = 0;
    virtual ::grpc::ClientAsyncWriterInterface< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>* PrepareAsyncStreamingDataCaptureUploadRaw(::grpc::ClientContext* context, ::viam::app::datasync::v1::StreamingDataCaptureUploadResponse* response, ::grpc::CompletionQueue* cq) = 0;
  };
  class Stub final : public StubInterface {
   public:
    ...
    std::unique_ptr< ::grpc::ClientWriter< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>> StreamingDataCaptureUpload(::grpc::ClientContext* context, ::viam::app::datasync::v1::StreamingDataCaptureUploadResponse* response) {
      return std::unique_ptr< ::grpc::ClientWriter< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>>(StreamingDataCaptureUploadRaw(context, response));
    }
    std::unique_ptr< ::grpc::ClientAsyncWriter< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>> AsyncStreamingDataCaptureUpload(::grpc::ClientContext* context, ::viam::app::datasync::v1::StreamingDataCaptureUploadResponse* response, ::grpc::CompletionQueue* cq, void* tag) {
      return std::unique_ptr< ::grpc::ClientAsyncWriter< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>>(AsyncStreamingDataCaptureUploadRaw(context, response, cq, tag));
    }
    std::unique_ptr< ::grpc::ClientAsyncWriter< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>> PrepareAsyncStreamingDataCaptureUpload(::grpc::ClientContext* context, ::viam::app::datasync::v1::StreamingDataCaptureUploadResponse* response, ::grpc::CompletionQueue* cq) {
      return std::unique_ptr< ::grpc::ClientAsyncWriter< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>>(PrepareAsyncStreamingDataCaptureUploadRaw(context, response, cq));
    }
    class async final :
     ...
     public:
      ...
      void StreamingDataCaptureUpload(::grpc::ClientContext* context, ::viam::app::datasync::v1::StreamingDataCaptureUploadResponse* response, ::grpc::ClientWriteReactor< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>* reactor) override;
     private:
      friend class Stub;
   ...
   private:
    ...
    ::grpc::ClientWriter< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>* StreamingDataCaptureUploadRaw(::grpc::ClientContext* context, ::viam::app::datasync::v1::StreamingDataCaptureUploadResponse* response) override;
    ::grpc::ClientAsyncWriter< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>* AsyncStreamingDataCaptureUploadRaw(::grpc::ClientContext* context, ::viam::app::datasync::v1::StreamingDataCaptureUploadResponse* response, ::grpc::CompletionQueue* cq, void* tag) override;
    ::grpc::ClientAsyncWriter< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>* PrepareAsyncStreamingDataCaptureUploadRaw(::grpc::ClientContext* context, ::viam::app::datasync::v1::StreamingDataCaptureUploadResponse* response, ::grpc::CompletionQueue* cq) override;
    const ::grpc::internal::RpcMethod rpcmethod_DataCaptureUpload_;
    const ::grpc::internal::RpcMethod rpcmethod_FileUpload_;
    const ::grpc::internal::RpcMethod rpcmethod_StreamingDataCaptureUpload_;
  };
  ...
  class Service : public ::grpc::Service {
   public:
    ...
    // StreamingDataCaptureUpload uploads the streaming contents and metadata for streaming binary (image + file) data,
    // where the first packet must be the UploadMetadata.
    virtual ::grpc::Status StreamingDataCaptureUpload(::grpc::ServerContext* context, ::grpc::ServerReader< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>* reader, ::viam::app::datasync::v1::StreamingDataCaptureUploadResponse* response);
  };
  ...
  template <class BaseClass>
  class WithAsyncMethod_StreamingDataCaptureUpload : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithAsyncMethod_StreamingDataCaptureUpload() {
      ::grpc::Service::MarkMethodAsync(2);
    }
    ~WithAsyncMethod_StreamingDataCaptureUpload() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status StreamingDataCaptureUpload(::grpc::ServerContext* /*context*/, ::grpc::ServerReader< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>* /*reader*/, ::viam::app::datasync::v1::StreamingDataCaptureUploadResponse* /*response*/) override {
      abort();
      return ::grpc::Status(::grpc::StatusCode::UNIMPLEMENTED, "");
    }
    void RequestStreamingDataCaptureUpload(::grpc::ServerContext* context, ::grpc::ServerAsyncReader< ::viam::app::datasync::v1::StreamingDataCaptureUploadResponse, ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>* reader, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncClientStreaming(2, context, reader, new_call_cq, notification_cq, tag);
    }
  };
  typedef WithAsyncMethod_DataCaptureUpload<WithAsyncMethod_FileUpload<WithAsyncMethod_StreamingDataCaptureUpload<Service > > > AsyncService;
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithCallbackMethod_StreamingDataCaptureUpload : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithCallbackMethod_StreamingDataCaptureUpload() {
      ::grpc::Service::MarkMethodCallback(2,
          new ::grpc::internal::CallbackClientStreamingHandler< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest, ::viam::app::datasync::v1::StreamingDataCaptureUploadResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, ::viam::app::datasync::v1::StreamingDataCaptureUploadResponse* response) { return this->StreamingDataCaptureUpload(context, response); }));
    }
    ~WithCallbackMethod_StreamingDataCaptureUpload() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status StreamingDataCaptureUpload(::grpc::ServerContext* /*context*/, ::grpc::ServerReader< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>* /*reader*/, ::viam::app::datasync::v1::StreamingDataCaptureUploadResponse* /*response*/) override {
    ...
    virtual ::grpc::ServerReadReactor< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>* StreamingDataCaptureUpload(
      ::grpc::CallbackServerContext* /*context*/, ::viam::app::datasync::v1::StreamingDataCaptureUploadResponse* /*response*/)  { return nullptr; }
  };
  typedef WithCallbackMethod_DataCaptureUpload<WithCallbackMethod_FileUpload<WithCallbackMethod_StreamingDataCaptureUpload<Service > > > CallbackService;
  ...
  template <class BaseClass>
  class WithGenericMethod_StreamingDataCaptureUpload : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithGenericMethod_StreamingDataCaptureUpload() {
      ::grpc::Service::MarkMethodGeneric(2);
    }
    ~WithGenericMethod_StreamingDataCaptureUpload() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status StreamingDataCaptureUpload(::grpc::ServerContext* /*context*/, ::grpc::ServerReader< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>* /*reader*/, ::viam::app::datasync::v1::StreamingDataCaptureUploadResponse* /*response*/) override {
  ...
  template <class BaseClass>
  class WithRawMethod_StreamingDataCaptureUpload : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawMethod_StreamingDataCaptureUpload() {
      ::grpc::Service::MarkMethodRaw(2);
    }
    ~WithRawMethod_StreamingDataCaptureUpload() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status StreamingDataCaptureUpload(::grpc::ServerContext* /*context*/, ::grpc::ServerReader< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>* /*reader*/, ::viam::app::datasync::v1::StreamingDataCaptureUploadResponse* /*response*/) override {
    ...
    void RequestStreamingDataCaptureUpload(::grpc::ServerContext* context, ::grpc::ServerAsyncReader< ::grpc::ByteBuffer, ::grpc::ByteBuffer>* reader, ::grpc::CompletionQueue* new_call_cq, ::grpc::ServerCompletionQueue* notification_cq, void *tag) {
      ::grpc::Service::RequestAsyncClientStreaming(2, context, reader, new_call_cq, notification_cq, tag);
    }
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithRawCallbackMethod_StreamingDataCaptureUpload : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawCallbackMethod_StreamingDataCaptureUpload() {
      ::grpc::Service::MarkMethodRawCallback(2,
          new ::grpc::internal::CallbackClientStreamingHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, ::grpc::ByteBuffer* response) { return this->StreamingDataCaptureUpload(context, response); }));
    }
    ~WithRawCallbackMethod_StreamingDataCaptureUpload() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status StreamingDataCaptureUpload(::grpc::ServerContext* /*context*/, ::grpc::ServerReader< ::viam::app::datasync::v1::StreamingDataCaptureUploadRequest>* /*reader*/, ::viam::app::datasync::v1::StreamingDataCaptureUploadResponse* /*response*/) override {
    ...
    virtual ::grpc::ServerReadReactor< ::grpc::ByteBuffer>* StreamingDataCaptureUpload(
      ::grpc::CallbackServerContext* /*context*/, ::grpc::ByteBuffer* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
