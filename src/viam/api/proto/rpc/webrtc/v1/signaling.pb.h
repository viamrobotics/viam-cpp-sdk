...
inline ::proto::rpc::webrtc::v1::AnswerRequestHeartbeatStage* AnswerRequest::release_heartbeat() {
  ...
  if (_internal_has_heartbeat()) {
    clear_has_stage();
    ::proto::rpc::webrtc::v1::AnswerRequestHeartbeatStage* temp = _impl_.stage_.heartbeat_;
    if (GetArenaForAllocation() != nullptr) {
      temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
    }
...
inline ::proto::rpc::webrtc::v1::AnswerRequestHeartbeatStage* AnswerRequest::_internal_mutable_heartbeat() {
  if (!_internal_has_heartbeat()) {
    clear_stage();
    set_has_heartbeat();
    _impl_.stage_.heartbeat_ = CreateMaybeMessage< ::proto::rpc::webrtc::v1::AnswerRequestHeartbeatStage >(GetArenaForAllocation());
  }
