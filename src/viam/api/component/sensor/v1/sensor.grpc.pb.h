...
class SensorService final {
 public:
  ...
  typedef WithAsyncMethod_GetReadings<WithAsyncMethod_DoCommand<WithAsyncMethod_GetStatus<WithAsyncMethod_GetGeometries<Service > > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_GetReadings<WithCallbackMethod_DoCommand<WithCallbackMethod_GetStatus<WithCallbackMethod_GetGeometries<Service > > > > CallbackService;
  ...
  typedef WithStreamedUnaryMethod_GetReadings<WithStreamedUnaryMethod_DoCommand<WithStreamedUnaryMethod_GetStatus<WithStreamedUnaryMethod_GetGeometries<Service > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_GetReadings<WithStreamedUnaryMethod_DoCommand<WithStreamedUnaryMethod_GetStatus<WithStreamedUnaryMethod_GetGeometries<Service > > > > StreamedService;
};
