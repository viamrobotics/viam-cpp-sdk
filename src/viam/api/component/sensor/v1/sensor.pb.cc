...
static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_component_2fsensor_2fv1_2fsensor_2eproto(&descriptor_table_component_2fsensor_2fv1_2fsensor_2eproto);
namespace viam {
namespace component {
namespace sensor {
namespace v1 {
