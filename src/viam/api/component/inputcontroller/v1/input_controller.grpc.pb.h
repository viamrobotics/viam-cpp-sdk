...
class InputControllerService final {
 public:
  ...
  typedef WithAsyncMethod_GetControls<WithAsyncMethod_GetEvents<WithAsyncMethod_StreamEvents<WithAsyncMethod_TriggerEvent<WithAsyncMethod_DoCommand<WithAsyncMethod_GetStatus<WithAsyncMethod_GetGeometries<Service > > > > > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_GetControls<WithCallbackMethod_GetEvents<WithCallbackMethod_StreamEvents<WithCallbackMethod_TriggerEvent<WithCallbackMethod_DoCommand<WithCallbackMethod_GetStatus<WithCallbackMethod_GetGeometries<Service > > > > > > > CallbackService;
  ...
  typedef WithStreamedUnaryMethod_GetControls<WithStreamedUnaryMethod_GetEvents<WithStreamedUnaryMethod_TriggerEvent<WithStreamedUnaryMethod_DoCommand<WithStreamedUnaryMethod_GetStatus<WithStreamedUnaryMethod_GetGeometries<Service > > > > > > StreamedUnaryService;
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_GetControls<WithStreamedUnaryMethod_GetEvents<WithSplitStreamingMethod_StreamEvents<WithStreamedUnaryMethod_TriggerEvent<WithStreamedUnaryMethod_DoCommand<WithStreamedUnaryMethod_GetStatus<WithStreamedUnaryMethod_GetGeometries<Service > > > > > > > StreamedService;
};
