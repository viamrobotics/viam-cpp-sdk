...
class SwitchService final {
 public:
  ...
  typedef WithAsyncMethod_SetPosition<WithAsyncMethod_GetPosition<WithAsyncMethod_GetNumberOfPositions<WithAsyncMethod_DoCommand<WithAsyncMethod_GetStatus<Service > > > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_SetPosition<WithCallbackMethod_GetPosition<WithCallbackMethod_GetNumberOfPositions<WithCallbackMethod_DoCommand<WithCallbackMethod_GetStatus<Service > > > > > CallbackService;
  ...
  typedef WithStreamedUnaryMethod_SetPosition<WithStreamedUnaryMethod_GetPosition<WithStreamedUnaryMethod_GetNumberOfPositions<WithStreamedUnaryMethod_DoCommand<WithStreamedUnaryMethod_GetStatus<Service > > > > > StreamedUnaryService;
  typedef Service SplitStreamedService;
  typedef WithStreamedUnaryMethod_SetPosition<WithStreamedUnaryMethod_GetPosition<WithStreamedUnaryMethod_GetNumberOfPositions<WithStreamedUnaryMethod_DoCommand<WithStreamedUnaryMethod_GetStatus<Service > > > > > StreamedService;
};
