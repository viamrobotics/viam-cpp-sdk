...
const char descriptor_table_protodef_component_2fgeneric_2fv1_2fgeneric_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    protodesc_cold) = {
...
static const ::_pbi::DescriptorTable* PROTOBUF_NONNULL const
    descriptor_table_component_2fgeneric_2fv1_2fgeneric_2eproto_deps[2] = {
        &::descriptor_table_common_2fv1_2fcommon_2eproto,
        &::descriptor_table_google_2fapi_2fannotations_2eproto,
};
static ::absl::once_flag descriptor_table_component_2fgeneric_2fv1_2fgeneric_2eproto_once;
PROTOBUF_CONSTINIT const ::_pbi::DescriptorTable descriptor_table_component_2fgeneric_2fv1_2fgeneric_2eproto = {
    false,
    false,
    659,
...
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::std::false_type
    _static_init2_ [[maybe_unused]] =
        (::_pbi::AddDescriptors(&descriptor_table_component_2fgeneric_2fv1_2fgeneric_2eproto),
         ::std::false_type{});
