...
class GantryService final {
 public:
  ...
  typedef WithAsyncMethod_GetPosition<WithAsyncMethod_MoveToPosition<WithAsyncMethod_Home<WithAsyncMethod_GetLengths<WithAsyncMethod_Stop<WithAsyncMethod_IsMoving<WithAsyncMethod_DoCommand<WithAsyncMethod_GetKinematics<WithAsyncMethod_GetGeometries<Service > > > > > > > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_GetPosition<WithCallbackMethod_MoveToPosition<WithCallbackMethod_Home<WithCallbackMethod_GetLengths<WithCallbackMethod_Stop<WithCallbackMethod_IsMoving<WithCallbackMethod_DoCommand<WithCallbackMethod_GetKinematics<WithCallbackMethod_GetGeometries<Service > > > > > > > > > CallbackService;
