...
class AudioInService final {
 public:
  ...
  typedef WithAsyncMethod_GetAudio<WithAsyncMethod_GetProperties<WithAsyncMethod_DoCommand<WithAsyncMethod_GetStatus<WithAsyncMethod_GetGeometries<Service > > > > > AsyncService;
  template <class BaseClass>
  ...
  typedef WithCallbackMethod_GetAudio<WithCallbackMethod_GetProperties<WithCallbackMethod_DoCommand<WithCallbackMethod_GetStatus<WithCallbackMethod_GetGeometries<Service > > > > > CallbackService;
  ...
  typedef WithStreamedUnaryMethod_GetProperties<WithStreamedUnaryMethod_DoCommand<WithStreamedUnaryMethod_GetStatus<WithStreamedUnaryMethod_GetGeometries<Service > > > > StreamedUnaryService;
  template <class BaseClass>
  ...
  typedef WithSplitStreamingMethod_GetAudio<WithStreamedUnaryMethod_GetProperties<WithStreamedUnaryMethod_DoCommand<WithStreamedUnaryMethod_GetStatus<WithStreamedUnaryMethod_GetGeometries<Service > > > > > StreamedService;
};
