...
inline ::viam::component::encoder::v1::PositionType GetPositionRequest::_internal_position_type() const {
  return static_cast< ::viam::component::encoder::v1::PositionType >(position_type_);
}
...
inline bool GetPropertiesResponse::_internal_angle_degrees_supported() const {
  return angle_degrees_supported_;
}
...
inline void GetPropertiesResponse::_internal_set_angle_degrees_supported(bool value) {
  ...
  angle_degrees_supported_ = value;
}
