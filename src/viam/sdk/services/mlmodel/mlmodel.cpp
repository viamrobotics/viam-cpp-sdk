...
const char* MLModelService::tensor_info::data_type_to_string(const data_types data_type) {
    ...
    if (data_type == data_types::k_int8) {
        return "int8";
    } else if (data_type == data_types::k_uint8) {
        return "uint8";
    } else if (data_type == data_types::k_int16) {
        return "int16";
    } else if (data_type == data_types::k_uint16) {
        return "uint16";
    } else if (data_type == data_types::k_int32) {
        return "int32";
    } else if (data_type == data_types::k_uint32) {
        return "uint32";
    } else if (data_type == data_types::k_int64) {
        return "int64";
    } else if (data_type == data_types::k_uint64) {
        return "uint64";
    } else if (data_type == data_types::k_float32) {
        return "float32";
    } else if (data_type == data_types::k_float64) {
        return "float64";
    }
    return nullptr;
}
