...
::grpc::Status EncoderServer::GetPosition(
    ...
    return make_service_helper<Encoder>(
        "EncoderServer::GetPosition", this, context, request)([&](auto& helper, auto& encoder) {
...
::grpc::Status EncoderServer::ResetPosition(
    ...
    return make_service_helper<Encoder>("EncoderServer::ResetPosition", this, context, request)(
...
::grpc::Status EncoderServer::GetProperties(
    ...
    return make_service_helper<Encoder>(
        "EncoderServer::GetProperties", this, context, request)([&](auto& helper, auto& encoder) {
...
::grpc::Status EncoderServer::GetGeometries(
    ...
    return make_service_helper<Encoder>(
        "EncoderServer::GetGeometries", this, context, request)([&](auto& helper, auto& encoder) {
...
::grpc::Status EncoderServer::DoCommand(grpc::ServerContext* context,
    ...
    return make_service_helper<Encoder>(
        "EncoderServer::DoCommand", this, context, request)([&](auto&, auto& encoder) {
