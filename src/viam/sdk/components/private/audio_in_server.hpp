...
class AudioInServer : public ResourceServer,
                      public viam::component::audioin::v1::AudioInService::Service {
   public:
    ...
    ::grpc::Status GetAudio(::grpc::ServerContext* context,
                            ...
                            ::grpc::ServerWriter<::viam::component::audioin::v1::GetAudioResponse>*
