...
::grpc::Status AudioOutServer::DoCommand(
    ::grpc::ServerContext*,
    const ::viam::common::v1::DoCommandRequest* request,
    ::viam::common::v1::DoCommandResponse* response) noexcept {
    return make_service_helper<AudioOut>("AudioOutServer::DoCommand", this, request)(
        [&](auto&, auto& audio_out) {
...
::grpc::Status AudioOutServer::GetGeometries(
    ...
    return make_service_helper<AudioOut>("AudioOutServer::GetGeometries", this, request)(
        [&](auto& helper, auto& audio_out) {
