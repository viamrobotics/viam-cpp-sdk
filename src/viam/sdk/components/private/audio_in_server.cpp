...
AudioInServer::AudioInServer(std::shared_ptr<ResourceManager> manager)
    ...
    ::grpc::Status AudioInServer::GetAudio(
        ...
        make_service_helper<AudioIn>(
            ...
            audio_in->get_audio(request->codec(), writeChunk, request->duration_seconds(), request->previous_timestamp_nanoseconds(), helper.getExtra());
        });
    ...
    return make_service_helper<AudioIn>("AudioInServer::DoCommand", this, request)([&](auto&, auto& audio_in) {
