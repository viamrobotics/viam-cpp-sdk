...
public:
  ...
  static digital_value from_proto(viam::component::board::v1::GetDigitalInterruptValueResponse proto);
  ...
  static viam::component::board::v1::GetDigitalInterruptValueResponse to_proto(digital_value digital_value);
  ...
  /// @brief PWMFrequency gets the PWM frequency of the given pin of a board of the underlying robot.
  /// @param pin TODO
  virtual pwm_frequency get_pwm_frequency(std::string pin) = 0;
  
  /// @brief SetPWMFrequency sets the given pin of a board of the underlying robot to the given PWM frequency. 0 will use the board's default PWM frequency.
  /// @param pin TODO
  ...
  /// @brief Analog Reader ReadAnalogReader reads off the current value of an analog reader of a board of the underlying robot.
  ...
  /// @brief Digital Interrupt GetDigitalInterruptValue returns the current value of the interrupt which is based on the type of interrupt.
  /// @param board_name TODO
  /// @param digital_interrupt_name TODO
  virtual digital_value read_digital_interrupt(std::string board_name, std::string digital_interrupt_name) = 0;
  
  /// @brief Power Management `SetPowerMode` sets the power consumption mode of the board to the requested setting for the given duration.
