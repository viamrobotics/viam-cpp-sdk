...
class BoardServer : public ResourceServerBase,
   ...
   public:
    ...
    ::grpc::Status DoCommand(::grpc::ServerContext* context,
                            ...
                            ::viam::component::board::v1::common.v1.DoCommandResponse* response) override;
   
    ::grpc::Status ReadAnalogReader(::grpc::ServerContext* context,
    ...
    ::grpc::Status GetDigitalInterruptValue(::grpc::ServerContext* context,
