...
::grpc::Status BoardServer::PWMFrequency(::grpc::ServerContext* context,
...
::grpc::Status BoardServer::SetPWMFrequency(::grpc::ServerContext* context,
...
::grpc::Status BoardServer::DoCommand(::grpc::ServerContext* context,
                        const ::viam::component::board::v1::common.v1.DoCommandRequest* request,
    ...
    AttributeMap result = board->do_command(request->TODO());

    return ::grpc::Status();
}

::grpc::Status BoardServer::ReadAnalogReader(::grpc::ServerContext* context,
    ...
    Board::analog_value result = board->read_analog(request->board_name(), request->analog_reader_name());
    response->set_value(result.value);

    return ::grpc::Status();
}

::grpc::Status BoardServer::GetDigitalInterruptValue(::grpc::ServerContext* context,
    ...
    Board::digital_value result = board->read_digital_interrupt(request->board_name(), request->digital_interrupt_name());
    response->set_value(result.value);

    return ::grpc::Status();
}

::grpc::Status BoardServer::SetPowerMode(::grpc::ServerContext* context,
...
std::shared_ptr<SubtypeService> BoardServer::sub_svc() {
    return sub_svc;
}
