...
/// @brief Defines a `ResourceRegistration` for the `MovementSensor` component.
/// @ingroup MovementSensor
class MovementSensorRegistration : public ResourceRegistration {
   public:
    MovementSensorRegistration(const google::protobuf::ServiceDescriptor* service_descriptor);
