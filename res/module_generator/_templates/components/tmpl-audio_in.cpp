...
class {{ .ModelPascal }} : public viam::sdk::AudioIn, public viam::sdk::Reconfigurable {
public:
    {{ .ModelPascal }}(const viam::sdk::Dependencies& deps, const viam::sdk::ResourceConfig& cfg) : AudioIn(cfg.name()) {
    ...
    void get_audio(
        ...
        const std::function<bool (audio_chunk &&)> & chunk_handler,
        const double & duration_seconds,
        const int64_t & previous_timestamp,
        const viam::sdk::ProtoStruct & extra) override
    {
        throw std::logic_error("\"get_audio\" not implemented");
    }
