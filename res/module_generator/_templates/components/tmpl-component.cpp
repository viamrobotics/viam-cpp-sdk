...
class {{ .ModelPascal }} : public viam::sdk::Component, public viam::sdk::Reconfigurable {
public:
    {{ .ModelPascal }}(const viam::sdk::Dependencies& deps, const viam::sdk::ResourceConfig& cfg) : Component(cfg.name()) {
