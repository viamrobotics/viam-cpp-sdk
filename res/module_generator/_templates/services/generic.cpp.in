...
class {{ .ModelPascal }} : public viam::sdk::Generic, public viam::sdk::Reconfigurable {
public:
    {{ .ModelPascal }}(const viam::sdk::Dependencies& deps, const viam::sdk::ResourceConfig& cfg) : Generic(cfg.name()) {
