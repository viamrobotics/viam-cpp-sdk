...
class {{ .ModelPascal }} : public viam::sdk::Service, public viam::sdk::Reconfigurable {
public:
    {{ .ModelPascal }}(const viam::sdk::Dependencies& deps, const viam::sdk::ResourceConfig& cfg) : Service(cfg.name()) {
